...
var THISPAGE = {
	...
	loadGrid: function(){
		...
		var colModels = [//fixed列宽度是否要固定不可变
						...
						{name:'mingcheng', label:'物资名称', index:'mingcheng', width:80, align:"center"},
						{name:'shuliang', label:'物资数量', index:'shuliang', width:60, align:"center"},
						{name:'fuzeren', label:'物资负责人', index:'fuzeren', width:120, align:"center"},
						{name:'suoshudanwei', label:'所属单位', index:'suoshudanwei', width:120, align:"center"},
		...
		_self.markRow = [];
		$("#grid").jqGrid({
			url:path+'/sgxxList!getWzkList.do',
