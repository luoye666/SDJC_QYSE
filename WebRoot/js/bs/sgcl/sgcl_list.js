...
var THISPAGE = {
	...
	loadGrid: function(){
		...
		var colModels = [//fixed列宽度是否要固定不可变
						...
						{name:'bianhao', label:'编号', index:'xingming', width:80, align:"center"},
						{name:'shigudanwei', label:'事故单位', index:'shenfenzhenghao', width:120, align:"center"},
						{name:'shebeimingcheng', label:'设备名称', index:'shi', width:120, align:"center"},
						{name:'fashengshijian', label:'发生时间', index:'quxian', width:80, align:"center",
						...
						{name:'fashengdidian', label:'发生地点', index:'quxian', width:80, align:"center"},
						{name:'shangwangqingkuang', label:'人员伤亡情况', index:'quxian', width:150, align:"center"},
						{name:'tjstate' , label:'提交状态', index:'diaoxiaoshijian', width:100, align:"center",
				        	formatter: function(value){
				        		if(value=="0"){
				        			return "未提交";
				        		}else{
