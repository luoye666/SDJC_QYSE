...
var THISPAGE = {
	...
	loadGrid: function(){
		...
		var colModels = [//fixed列宽度是否要固定不可变
						...
						{name:'xiugairen', label:'最后修改人', index:'xiugairen', width:50,align:"center"},
						{name:'xiugairiqi' , label:'最后修改时间', index:'xiugairiqi', width:90, align:"center",formatter:function(value){
		...
		_self.markRow = [];
		$("#grid").jqGrid({
			url:path+'/seList!getLiCiXiuGaiJiLu.do?seid='+seid,
