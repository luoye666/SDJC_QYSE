...
var THISPAGE = {
	...
	loadGrid: function(){
		...
		var colModels = [//fixed列宽度是否要固定不可变
						...
						{name:'enterpriseName', label:'企业名称', index:'enterpriseName', width:120, align:"center"},
						{name:'enterpriseAddress', label:'企业地址', index:'enterpriseAddress', width:100,align:"center",hidden:true},
						{name:'personInCharge', label:'负责人', index:'personInCharge', width:100, align:"center"},
						{name:'phone', label:'联系电话', index:'phone', width:100, align:"center"},  
						{name:'inspectReportFile', label:'报告路径', index:'inspectReportFile', width:100, align:"center",hidden:true},  
						{name:'createTime' , label:'创建日期', index:'createTime', width:70, align:"center",
		...
		_self.markRow = [];
		$("#grid").jqGrid({
			url:path+'/syUtilsList!findEnterpriseInspectList.do?type='+type,
