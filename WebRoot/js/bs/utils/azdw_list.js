...
var THISPAGE = {
	...
	loadGrid: function(){
		...
		var colModels = [//fixed列宽度是否要固定不可变
						...
						{name:'unitsname', label:'安装单位', index:'unitsname', width:120, align:"center"},
						{name:'unitsid', label:'机构代码', index:'unitsid', width:80, align:"center"},
						{name:'corporation', label:'单位负责人', index:'corporation', width:100,align:"center"},
						{name:'shi', label:'所属市', index:'shi', width:100,align:"center"},
						{name:'quxian', label:'所属区县', index:'quxian', width:100,align:"center"},
						{name:'gaozhishu', label:'告知书', index:'gaozhishu', width:100, align:"center",
			        		formatter:function(value,opt, row){
				        		value = '<a href="javascript:void(0)" onclick="editGzs('+row.id+',\''+row.unitsname+'\')">详细告知书</a>';
								return value;
			        	}},
