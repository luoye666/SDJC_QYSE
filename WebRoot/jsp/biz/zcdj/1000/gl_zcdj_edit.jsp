			    	...
			    	<div class="formHiddenRegion">
						...
						<table>
							<tr>
								<th>登记类别：</th>
								<td>
									<select class="long98" name="register.dengjileibie" id="djlb" style="width:179px">
										<option value=""></option>
						...
						<table class="tabjcxx">
							...
							<tr>
								<th>检验类别</th>
								<td>
									<select class="long98" name="register.jianyanleibie" id="jylb" style="width:179px">
										<option value=""></option>
							...
							<tr>
								...
								<td>
									<select class="long98" name="register.jianyanjielun" id="jyjl" style="width:179px">
										<option value=""></option>
					...
					<li class="tab_con">
							<div >
								...
								<table class="tabjcxx">
									...
									<tr>
										...
										<th >设备级别</th>
										<td >
											<input class="ui-input long80" name="register.shebeijibie" value="${register.shebeijibie}"/>
										</td>
									</tr>
									<tr>
										...
										<th >设计文件鉴定日期</th>
										<td >
											<input class="ui-input long80" name="register.wenjianjiandingriqi" value="${register.wenjianjiandingriqi}" onclick="WdatePicker()"/>
										</td>
										<th >鉴定报告书编号</th>
										<td >
											<input class="ui-input long80" name="register.jiandingbaogaobianhao" value="${register.jiandingbaogaobianhao}"/>
										</td>
									</tr>
									<tr>
										<th >鉴定机构名称</th>
										<td colspan="3">
											<input class="ui-input long80" name="register.jiandingjigou" value="${register.jiandingjigou}"/>
										</td>
									</tr>
									<tr>
										...
										<th >额定蒸发量（热功率）</th>
										<td >
											<input class="ui-input" name="register.edingzhengfaliang" style="width:80px" value="${register.edingzhengfaliang}"/>
											<select name="register.edingqizhongliang_dw" id="edgl_dw" style="width:70px">
												<option value="t/h" ${register.edingqizhongliang_dw == "t/h" ? "selected":""}>t/h</option>
												<option value="MW" ${register.edingqizhongliang_dw == "MW" ? "selected":""}>MW</option>
											</select>
										</td>
										<th >额定工作压力</th>
										<td >
											<input class="ui-input long80" name="register.gongzuoyali" value="${register.gongzuoyali}"/>MPa
										</td>
									</tr>
									<tr>
										<th >额定工作温度</th>
										<td >
											<input class="ui-input long80" name="register.gongzuowendu" value="${register.gongzuowendu}"/>℃
										</td>
										<th >设计热效率</th>
										<td >
											<input class="ui-input long80" name="register.shejireciaolv" value="${register.shejireciaolv}"/>%
										</td>
									</tr>
									<tr>
										<th >给水温度</th>
										<td >
											<input class="ui-input long80" name="register.geishuiwendu" value="${register.geishuiwendu}"/>℃
										</td>
										<th >额定出水（油）/回水（油）温度</th>
										<td >
											<input class="ui-input long80" name="register.edingchushui" value="${register.edingchushui}"/> /
											<input class="ui-input long80" name="register.huishuiwendu" value="${register.huishuiwendu}"/> ℃
										</td>
									</tr>
									<tr>
										<th >锅炉本体水（油）容积</th>
										<td >
											<input class="ui-input long80" name="register.rongji" value="${register.rongji}"/>L
										</td>
										<th >整装锅炉本体液压试验介质/压力</th>
										<td >
											<input class="ui-input long80" name="register.bentijiezhi" value="${register.bentijiezhi}"/> /
											<input class="ui-input long80" name="register.bentiyali" value="${register.bentiyali}"/> MPa
										</td>
									</tr>
									<tr>
										<th >再热器进（出）口温度</th>
										<td >
											<input class="ui-input long80" name="register.jinkouwendu" value="${register.jinkouwendu}"/> /
											<input class="ui-input long80" name="register.chukouwendu" value="${register.chukouwendu}"/> ℃
										</td>
										<th >再热器进（出）口压力</th>
										<td >
											<input class="ui-input long80" name="register.chukouyali" value="${register.chukouyali}"/> /
											<input class="ui-input long80" name="register.jinkouyanli" value="${register.jinkouyanli}"/> MPa
										</td>
									</tr>
									<tr>
										<th >再热蒸汽流量</th>
										<td >
											<input class="ui-input long80" name="register.zhengqiliuliang" value="${register.zhengqiliuliang}"/>t/h
										</td>
										<th >有机热载体锅炉气密试验介质/压力</th>
										<td >
											<input class="ui-input long80" name="register.qimijiezhi" value="${register.qimijiezhi}"/> /
											<input class="ui-input long80" name="register.qimiyali" value="${register.qimiyali}"/> MPa
										</td>
									</tr>
									<tr>
										<th >燃烧方式</th>
										<td >
											<select class="long98" name="register.ranshaofangshi" id="rsfs" style="width:179px">
												<option value=""></option>
												<option value="层燃" ${register.ranshaofangshi == "层燃" ? "selected":""}>层燃</option>
												<option value="室燃" ${register.ranshaofangshi == "室燃" ? "selected":""}>室燃</option>
												<option value="流化床" ${register.ranshaofangshi == "流化床" ? "selected":""}>流化床</option>
												<option value="其他" ${register.ranshaofangshi == "其他" ? "selected":""}>其他</option>
											</select>
										</td>
										<th >燃料（或者热源）种类</th>
										<td >
											<select class="long98" name="register.ranliaozhonglei" id="rlzl" style="width:179px">
												<option value=""></option>
												<option value="油" ${register.ranliaozhonglei == "油" ? "selected":""}>油</option>
												<option value="气" ${register.ranliaozhonglei == "气" ? "selected":""}>气</option>
												<option value="煤" ${register.ranliaozhonglei == "煤" ? "selected":""}>煤</option>
												<option value="煤、气" ${register.ranliaozhonglei == "煤、气" ? "selected":""}>煤、气</option>
												<option value="水煤浆" ${register.ranliaozhonglei == "水煤浆" ? "selected":""}>水煤浆</option>
												<option value="生物质" ${register.ranliaozhonglei == "生物质" ? "selected":""}>生物质</option>
												<option value="木材" ${register.ranliaozhonglei == "木材" ? "selected":""}>木材</option>
												<option value="电" ${register.ranliaozhonglei == "电" ? "selected":""}>电</option>
												<option value="余热" ${register.ranliaozhonglei == "余热" ? "selected":""}>余热</option>
												<option value="煤粉" ${register.ranliaozhonglei == "煤粉" ? "selected":""}>煤粉</option>
												<option value="其他" ${register.ranliaozhonglei == "其他" ? "selected":""}>其他</option>
											</select>
										</td>
									</tr>
									<tr>
										...
										<th >监检机构</th>
										<td colspan="3">
											<input class="ui-input long80" name="register.zhizaojianjianjigou" value="${register.zhizaojianjianjigou}"/>
										</td>
									</tr>
									<tr>
										<th >机构组织代码</th>
										<td >
											<input class="ui-input long80" name="register.jianjiandanweidaima" value="${register.jianjiandanweidaima}"/>
										</td>
										<th >机构核准证编号</th>
										<td >
											<input class="ui-input long80" name="register.jianjianjigouhezhunzheng" value="${register.jianjianjigouhezhunzheng}"/>
										</td>
									</tr>
								</table>
					    		...
					    		<table class="tabjcxx" id="hzb" style="width: 80%">
					    			...
					    			<tr>
						    			<td>
						    				<input class="ui-input long98" inumb="0" name="fjfj_list[${i.index}].xinghao" value="${g.xinghao}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98"  inumb="0" name="fjfj_list[${i.index}].guige" value="${g.guige}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98" inumb="0" name="fjfj_list[${i.index}].shuliang" value="${g.shuliang}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98" inumb="0" name="fjfj_list[${i.index}].zhizaochangjia" value="${g.zhizaochangjia}"/>
						    			</td>
						    			<td>
						...
						<li class="tab_con">
					    		...
					    		<table class="tabjcxx" id="bj" style="width: 100%">
					    			...
					    			<tr>
						    			<td>
						    				<input class="ui-input" inum="0" name="gl_hzb_list[${i.index}].shouyabujian" value="${g.shouyabujian}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input" inum="0" name="gl_hzb_list[${i.index}].cailiao" value="${g.cailiao}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input" inum="0" name="gl_hzb_list[${i.index}].bihou" value="${g.bihou}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input" inum="0" name="gl_hzb_list[${i.index}].fangfa" value="${g.fangfa}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input" inum="0" name="gl_hzb_list[${i.index}].bili" value="${g.bili}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input" inum="0" name="gl_hzb_list[${i.index}].wendu" value="${g.wendu}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input" inum="0" name="gl_hzb_list[${i.index}].shijian" value="${g.shijian}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input" inum="0" name="gl_hzb_list[${i.index}].jiezhi" value="${g.jiezhi}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input" inum="0" name="gl_hzb_list[${i.index}].yali" value="${g.yali}"/>
						    			</td>
...
<script type="text/javascript" >
	...
	var sblbdm = "${register.shebeileibiedaima}";
	var xxnum = "${fn:length(fjfjList)}";
	var bjnum = "${fn:length(glhzbList)}";
	...
	$().ready(function(){
		...
		$("#hzb_add").click(function(){
			var tr = "<tr>";
			tr += '<td><input class="ui-input " name="fjfj_list['+xxnum+'].xinghao" /></td>';
			tr += '<td><input class="ui-input " name="fjfj_list['+xxnum+'].guige" /></td>';
			tr += '<td><input class="ui-input " name="fjfj_list['+xxnum+'].shuliang" /></td>';
			tr += '<td><input class="ui-input " name="fjfj_list['+xxnum+'].zhizaochangjia" /></td>';
		...
		$("#bj_add").click(function(){
			var tr = "<tr>";
			tr += '<td><input class="ui-input " name="gl_hzb_list['+bjnum+'].shouyabujian" /></td>';
			tr += '<td><input class="ui-input " name="gl_hzb_list['+bjnum+'].cailiao" /></td>';
			tr += '<td><input class="ui-input " name="gl_hzb_list['+bjnum+'].bihou" /></td>';
			tr += '<td><input class="ui-input " name="gl_hzb_list['+bjnum+'].fangfa" /></td>';
			tr += '<td><input class="ui-input " name="gl_hzb_list['+bjnum+'].bili" /></td>';
			tr += '<td><input class="ui-input " name="gl_hzb_list['+bjnum+'].wendu" /></td>';
			tr += '<td><input class="ui-input " name="gl_hzb_list['+bjnum+'].shijian" /></td>';
			tr += '<td><input class="ui-input " name="gl_hzb_list['+bjnum+'].jiezhi" /></td>';
			tr += '<td><input class="ui-input " name="gl_hzb_list['+bjnum+'].yali" /></td>';
			tr += '<td><a href="javascript:void(0)" onclick="delBjRow(this)">删除</a></td>';
			tr += '</tr>';
			$("#bj").append(tr);
			bjnum++;
		});
