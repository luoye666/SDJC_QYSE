...
<div class="wrapper">
  ...
  <div class="mod-search cf" id="Toolbar">
  	...
  	<a class="ui-btn ui-btn-sp" id="mnubtn_zcdj_ztqh">下载使用标志</a><a class="ui-btn ui-btn-sp" id="mnubtn_zcdj_ztqh">下载使用登记</a>
...
var tjstate = "${param.tjstate}";
	...
	$(function(){
			$.post("<%=path%>/dirList!getSetypeList.do",{},
				...
				//	setype += '<li><a onClick="selDw(\'Q100\',\'车用气瓶\')">车用气瓶</a></li>';
