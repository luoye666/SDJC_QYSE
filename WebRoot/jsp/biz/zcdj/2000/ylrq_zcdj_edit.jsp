			    	...
			    	<div class="formHiddenRegion">
						...
						<table class="tabjcxx">
							...
							<tr>
								...
								<td>
									<select class="long98" name="register.jianyanleibie" id="jylb">
										...
										<option value="制造监督检验" ${register.jianyanleibie=="制造监督检验" ? "selected" : ""}>制造监督检验</option>
							...
							<tr>
								<th>下次检验日期</th>
								<td>
									<input class="ui-input long98" name="register.xiacijianyanriqi" onclick="WdatePicker()" value="<fmt:formatDate value='${register.xiacijianyanriqi}' pattern='yyyy-MM-dd'/>" />
								</td>
								<th colspan="2"></th>
								<td>
								</td>
					...
					<li class="tab_con">
							<div id="zdftzdrxd_cw" >
								...
								<table class="tabjcxx">
									<tr>
										...
										<td colspan="3">
											<input class="ui-input long80" name="register.rongqileibie" value="${register.rongqileibie}"/>
										</td>
									</tr>
									<tr>
										<th colspan="2">产品名称</th>
									...
									<tr>
										...
										<td colspan="5">
											<input class="ui-input long80" name="register.chanpinbiaozhun" value="${register.chanpinbiaozhun}"/>
										</td>
									...
									<tr>
										...
										<td colspan="2">
											<input class="ui-input long80" name="register.rongji" value="${register.rongji}"/>m³
										</td>
										<th colspan="2">容器内径</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.neijing" value="${register.neijing}"/>mm
										</td>
										<th colspan="2">容器高（长）</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.rongqigao" value="${register.rongqigao}"/>mm
										</td>
									</tr>
									<tr>
										<th rowspan="4">材料</th>
										<th >筒体(球壳)</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.cailiao_tongti" value="${register.cailiao_tongti}"/>
										</td>
										<th rowspan="4">厚度</th>
										<th >筒体(球壳)</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.hd_tongti" value="${register.hd_tongti}"/>mm
										</td>
										<th colspan="2" rowspan="2">容器总重量</th>
										<td colspan="2" rowspan="2">
											<input class="ui-input long80" name="register.rongqizongzhongliang" value="${register.rongqizongzhongliang}"/>kg
										</td>
									</tr>
									<tr>
										<th >封头</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.cailiao_fengtou" value="${register.cailiao_fengtou}"/>
										</td>
										<th >封头</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.hd_fengtou" value="${register.hd_fengtou}"/>mm
										</td>
									</tr>
									<tr>
										<th >衬里</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.cailiao_chenli" value="${register.cailiao_chenli}"/>
										</td>
										<th >衬里</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.hd_chenli" value="${register.hd_chenli}"/>mm
										</td>
										<th colspan="2" rowspan="2">盛装介质重量</th>
										<td colspan="2" rowspan="2">
											<input class="ui-input long80" name="register.jiezhizhongliang" value="${register.jiezhizhongliang}"/>kg
										</td>
									</tr>
									<tr>
										<th >夹套</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.cailiao_jiatao" value="${register.cailiao_jiatao}"/>
										</td>
										<th >夹套</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.hd_jiatao" value="${register.hd_jiatao}"/>mm
										</td>
									</tr>
									<tr>
										...
										<th >壳程</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.sjyl_kecheng" value="${register.sjyl_kecheng}"/>Mpa
										</td>
										<th rowspan="3">设计温度</th>
										<th >壳程</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.sjwd_kecheng" value="${register.sjwd_kecheng}"/>℃
										</td>
										<th rowspan="3">最高允许<br/>工作压力</th>
										<th >壳程</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.gzyl_kecheng" value="${register.gzyl_kecheng}" />Mpa
										</td>
									</tr>
									<tr>
										<th >管程</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.sjyl_guancheng" value="${register.sjyl_guancheng}"/>Mpa
										</td>
										<th >管程</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.sjwd_guancheng" value="${register.sjwd_guancheng}"/>℃
										</td>
										<th >管程</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.gzyl_guancheng" value="${register.gzyl_guancheng}"/>Mpa
										</td>
									</tr>
									<tr>
										<th >夹套</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.sjyl_jiatao" value="${register.sjyl_jiatao}"/>Mpa
										</td>
										<th >夹套</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.sjwd_jiatao" value="${register.sjwd_jiatao}"/>℃
										</td>
										<th >夹套</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.gzyl_jiatao" value="${register.gzyl_jiatao}"/>Mpa
										</td>
									</tr>
									<tr>
										<th colspan="2">壳程介质</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.kechengjiezhi" value="${register.kechengjiezhi}"/>
										</td>
										<th colspan="2">管程介质</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.guanchengjiezhi" value="${register.guanchengjiezhi}"/>
										</td>
										<th colspan="2">夹套介质</th>
										<td colspan="2">
											<input class="ui-input long80" name="register.jiataojiezhi" value="${register.jiataojiezhi}"/>
										</td>
									</tr>
									<tr>
										...
										<td colspan="4">
											<input class="ui-input long80" name="register.zhutijiegouxingshi" value="${register.zhutijiegouxingshi}"/>
										</td>
										<th colspan="3">安装型式</th>
										<td colspan="3">
											<input class="ui-input long80" name="register.anzhuangxingshi" value="${register.anzhuangxingshi}" />
										</td>
									</tr>
									<tr>
										<th colspan="2">支座型式</th>
										<td colspan="4">
											<input class="ui-input long80" name="register.zhizuoxingshi" value="${register.zhizuoxingshi}"/>
										</td>
										<th colspan="3">保温绝热方式</th>
										<td colspan="3">
											<input class="ui-input long80" name="register.baowenjuerefangshi" value="${register.baowenjuerefangshi}"/>
										</td>
									</tr>
									<tr>
										...
										<td colspan="4">
											<input class="ui-input long80" name="register.wusunjiancefangfa" value="${register.wusunjiancefangfa}"/>
										</td>
										<th colspan="3">无损检测比例</th>
										<td colspan="3">
											<input class="ui-input long80" name="register.wusunjiancebili" value="${register.wusunjiancebili}"/>%
										</td>
									</tr>
									<tr>
										<th colspan="2">耐压试验种类</th>
										<td colspan="4">
											<input class="ui-input long80" name="register.naiyashiyanzhonglei" value="${register.naiyashiyanzhonglei}"/>
										</td>
										<th colspan="3">耐压试验压力</th>
										<td colspan="3">
											<input class="ui-input long80" name="register.naiyashiyanyali" value="${register.naiyashiyanyali}"/>Mpa
										</td>
									</tr>
									<tr>
										<th colspan="2">泄露试验种类</th>
										<td colspan="4">
											<input class="ui-input long80" name="register.xieloushiyanzhonglei" value="${register.xieloushiyanzhonglei}"/>
										</td>
										<th colspan="3">泄露试验压力</th>
										<td colspan="3">
											<input class="ui-input long80" name="register.xieloushiyanyali" value="${register.xieloushiyanyali}"/>Mpa
										</td>
									</tr>
									<tr>
										<th colspan="3">热处理种类</th>
										<td colspan="4">
											<input class="ui-input long80" name="register.rechulizhonglei" value="${register.rechulizhonglei}"/>
										</td>
										<th colspan="3">热处理温度</th>
										<td colspan="3">
											<input class="ui-input long80" name="register.rechuliwendu" value="${register.rechuliwendu}"/>℃
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="4">
											<input class="ui-input long80" name="register.zhizaojianjianjigou_daima" value="${register.zhizaojianjianjigou_daima}"/>
										</td>
						...
						<li class="tab_con">
					    		...
					    		<table class="tabjcxx" id="hzb" style="width: 100%">
					    			...
					    			<tr>
						    			<td>
						    				<input class="ui-input long98" inum="0" name="fjfj_list[${i.index}].mingcheng" value="${y.mingcheng}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98" inum="0" name="fjfj_list[${i.index}].xinghao" value="${y.xinghao}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98"  inum="0" name="fjfj_list[${i.index}].guige" value="${y.guige}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98" inum="0" name="fjfj_list[${i.index}].shuliang" value="${y.shuliang}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98" inum="0" name="fjfj_list[${i.index}].zhizaochangjia" value="${y.zhizaochangjia}"/>
						    			</td>
						    			<td>
