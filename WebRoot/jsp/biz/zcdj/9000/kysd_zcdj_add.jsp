						...
						<li class="tab_con">
								...
								<table class="tabjcxx" id="cksfzz">
									...
									<tr>
										<th>平  距</th>
										<td>
											<input class="ui-input long85" name="register.pingju" />m
										</td>
										<th>支架数目</th>
										<td colspan="2">
											<input class="ui-input long85" name="register.zhijiashumu" />个
										</td>
									</tr>
									<tr>
										<th>斜  长</th>
										<td>
											<input class="ui-input long85" name="register.changdu" />m
										</td>
										<th>主电机型号和功率</th>
										<td colspan="2">
											<input class="ui-input long85" name="register.dianjixinghao" />kW
										</td>
									</tr>
									<tr>
										<th>高  差</th>
										<td>
											<input class="ui-input long85" name="register.gaocha" />m
										</td>
										<th>张紧油压(重锤重量)</th>
										<td colspan="2">
											<input class="ui-input long98" name="register.zhangjinyouya" />
										</td>
									</tr>
									<tr>
										<th>运  量</th>
										<td>
											<input class="ui-input" name="register.yunzainengli" />人/小时
										</td>
										<th>运载索(牵引索、平衡索)</th>
										<td colspan="2">
									...
									<tr>
										<th>速  度</th>
										<td>
											<input class="ui-input long85" name="register.sudu" />m/s
										</td>
										<th>承载索</th>
										<td colspan="2">
									...
									<tr>
										<th>索  距</th>
										<td>
											<input class="ui-input long85" name="register.suoju" />m
										</td>
										<th>运载工具数量和类型</th>
										<td colspan="2">
											<input class="ui-input long98" name="register.yunzaicheliangxingshi"/>
										</td>
									</tr>
									<tr>
										<th colspan="6">
									...
									<c:forEach items="${kysdCpsjblist}" var="k" varStatus="i">
									<tr>
										<td>
											${i.index+1}
										</td>
										<td>
											<input class="ui-input long98" name="fjfj_list[${i.index}].mingcheng" value="${k.name}" />
										</td>
										<td>
											<input class="ui-input long98" name="fjfj_list[${i.index}].hegezhenghao" />
										</td>
										<td>
...
<script src="<%=path %>/js/page_tabs/page_tabs.js"></script>
	...
	$("#zdwx").selectmenu();
	$("#lengku").selectmenu();
	var xxnum = "${fn:length(kysdCpsjblist)}";
