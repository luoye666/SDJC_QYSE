		   		...
		   		<div>
								...
								<table class="tabjcxx" id="cksfzz">
									<tr>
										...
										<td>${reg.shebeipinzhong}</td>
										<td>产品总图图号</td>
										<td colspan="2">${reg.chanpintuhao}</td>
									</tr>
									<tr>
										<td colspan="5">主要参数</td>
									</tr>
									<tr>
										<td>平  距</td>
										<td>${reg.pingju}m</td>
										<td>支架数目</td>
										<td colspan="2">${reg.zhijiashumu}个</td>
									</tr>
									<tr>
										<td>斜  长</td>
										<td>${reg.changdu}m</td>
										<td>主电机型号和功率</td>
										<td colspan="2">${reg.dianjixinghao}kW</td>
									</tr>
									<tr>
										<td>高  差</td>
										<td>${reg.gaocha}m</td>
										<td>张紧油压(重锤重量)</td>
										<td colspan="2">${reg.zhangjinyouya}</td>
									</tr>
									<tr>
										<td>运  量</td>
										<td>${reg.yunzainengli}人/小时</td>
										<td>运载索(牵引索、平衡索)</td>
										<td colspan="2">${reg.qianyinsuoxinghao}</td>
									</tr>
									<tr>
										<td>速  度</td>
										<td>${reg.sudu}m/s</td>
										<td>承载索</td>
										<td colspan="2">${reg.chengzaisuoxinghao}</td>
									</tr>
									<tr>
										<td>索  距</td>
										<td>${reg.suoju}m</td>
										<td>运载工具数量和类型</td>
										<td colspan="2">${reg.yunzaicheliangxingshi}</td>
									</tr>
									<tr>
										<td colspan="6">
											主要部件
