						...
						<li class="tab_con">
								...
								<table class="tabjcxx" id="cksfzz">
									...
									<tr>
										...
										<td>
											<input type="radio" name="register.shebeijibie" value="A" ${register.shebeijibie == "A" ? "checked" : ""} />A
											<input type="radio" name="register.shebeijibie" value="B" ${register.shebeijibie == "B" ? "checked" : ""} />B
											<input type="radio" name="register.shebeijibie" value="C" ${register.shebeijibie == "C" ? "checked" : ""} />C
											<input type="radio" name="register.shebeijibie" value="其它" ${register.shebeijibie == "其它" ? "checked" : ""} />其它
										</td>
										<th>设备使用方式</th>
										<td colspan="2">
											<input type="radio" name="register.caozuofangshi" value="固定式" ${register.caozuofangshi == "固定式" ? "checked" : ""} />固定式
											<input type="radio" name="register.caozuofangshi" value="移动式" ${register.caozuofangshi == "移动式" ? "checked" : ""} />移动式
										</td>
									</tr>
									<tr>
										...
										<th>运行速度</th>
										<td>
											<input class="ui-input" name="register.sudu" value="${register.sudu}" />km/h(m/s)
										</td>
										<th>转速</th>
										<td colspan="2">
											<input class="ui-input" name="register.zhuansu" value="${register.zhuansu}"/>rpm
										</td>
									</tr>
									<tr>
										<th>运行高度</th>
										<td>
											<input class="ui-input long85" name="register.yunxinggaodu" value="${register.yunxinggaodu}" />m
										</td>
										<th>回转直径（静止）</th>
										<td colspan="2">
											<input class="ui-input long85" name="register.huizhuanzhijing" value="${register.huizhuanzhijing}" />m
										</td>
									</tr>
									<tr>
										<th>每车承载人数或每列承载人数或每舱承载人数</th>
										<td>
											<input class="ui-input long85" name="register.edingchengkerenshu" value="${register.edingchengkerenshu}" />人
										</td>
										<th>车辆数或列车数或座舱数</th>
										<td colspan="2">
											<input class="ui-input long85" name="register.cheliangshu" value="${register.cheliangshu}" />人
										</td>
									</tr>
									<tr>
										<th>轨道高度</th>
										<td>
											<input class="ui-input long98" name="register.guidaogaodu" value="${register.guidaogaodu}" />m
										</td>
										<th>高差</th>
										<td colspan="2">
											<input class="ui-input long98" name="register.gaocha" value="${register.gaocha}" />m
										</td>
									</tr>
									<tr>
										<th>单侧摆角</th>
										<td>
											<input class="ui-input long85" name="register.baijiao" value="${register.baijiao}" />°
										</td>
										<th>最大坡度</th>
										<td colspan="2">
											<input class="ui-input long85" name="register.qingjiao" value="${register.qingjiao}" />°
										</td>
									</tr>
									<tr>
										<th>设计最大加速度</th>
										<td>
											<input class="ui-input long85" name="register.jiasudu" value="${register.jiasudu}" />G
										</td>
										<th></th>
										<td colspan="2"></td>
									</tr>
									<tr>
										...
										<td colspan="4">
											<input class="ui-input long98" name="register.shuoming" value="${register.shuoming}" />
										</td>
									</tr>
									<tr>
										<th colspan="6">
