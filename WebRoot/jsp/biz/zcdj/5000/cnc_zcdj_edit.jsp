							...
							<div id="chache" style="display: none;">
								...
								<table class="tabjcxx">
									...
									<tr>
										...
										<td>
											<input class="ui-input long80" name="register.zzdw_zigezhengshuhao" value="${register.zzdw_zigezhengshuhao}"/>
										</td>
										<th colspan="2">型式试验证书编号</th>
										<td>
											<input class="ui-input long80" name="register.xingshishiyanzhengshu" value="${register.xingshishiyanzhengshu}"/>
										</td>
									</tr>
									<tr>
										<th colspan="2">发动机（电机）编号</th>
										<td>
											<input class="ui-input long80" name="register.fadongjibianhao" value="${register.fadongjibianhao}"/>
										</td>
										<th colspan="2">车架编号</th>
										<td>
											<input class="ui-input long80" name="register.chejiabianhao" value="${register.chejiabianhao}"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<input class="ui-input long80" name="register.edingqizhongliang" value="${register.edingqizhongliang}"/>kg
										</td>
										<th colspan="2">载荷中心距</th>
										<td>
											<input class="ui-input long80" name="register.zaihezhongxinju" value="${register.zaihezhongxinju}"/>mm
										</td>
									</tr>
									<tr>
										<th colspan="2">自重</th>
										<td>
											<input class="ui-input long80" name="register.zizhong" value="${register.zizhong}"/>kg
										</td>
										<th colspan="2">动力方式</th>
										<td>
											<input class="ui-input long80" name="register.donglifangshi" value="${register.donglifangshi}"/>
										</td>
									</tr>
									<tr>
										<th colspan="2">系统电压</th>
										<td>
											<input class="ui-input long80" name="register.xitongdianya" value="${register.xitongdianya}"/>V
										</td>
										<th colspan="2">发动机（电机）额定功率</th>
										<td>
											<input class="ui-input long80" name="register.fadongjiedinggonglv" value="${register.fadongjiedinggonglv}"/>kW
										</td>
									</tr>
									<tr>
										...
										<th >空载</th>
										<td>
											<input class="ui-input long80" name="register.yxsd_kongzai" value="${register.yxsd_kongzai}"/>
										</td>
										<th rowspan="2">防爆</th>
										<th >等级</th>
										<td>
											<input class="ui-input long80" name="register.dengji" value="${register.dengji}"/>
										</td>
									</tr>
									<tr>
										<th >额定起重量</th>
										<td>
											<input class="ui-input long80" name="register.yxsd_edingqizhongliang" value="${register.yxsd_edingqizhongliang}"/>
										</td>
										<th >防爆使用场所</th>
										<td>
											<input class="ui-input long80" name="register.fangbaoshiyongchangsuo" value="${register.fangbaoshiyongchangsuo}"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<input class="ui-input long80" name="register.menjiaxingshi" value="${register.menjiaxingshi}"/>
										</td>
										<th colspan="2">空载最大起升高度</th>
										<td>
											<input class="ui-input long80" name="register.qishenggaodu" value="${register.qishenggaodu}"/>mm
										</td>
									</tr>
									<tr>
										<th colspan="2" rowspan="2">（全）自由起升高度</th>
										<td rowspan="2">
											<input class="ui-input long80" name="register.ziyougaodu" value="${register.ziyougaodu}"/>mm
										</td>
										<th rowspan="2">门架倾角(°)</th>
										<th>前</th>
										<td>
											<input class="ui-input long80" name="register.menjiaqingjiao_qian" value="${register.menjiaqingjiao_qian}"/>mm
										</td>
									</tr>
									<tr>
										<th>后</th>
										<td>
											<input class="ui-input long80" name="register.menjiaqingjiao_hou" value="${register.menjiaqingjiao_hou}"/>mm
										</td>
									</tr>
									<tr>
										...
										<th >空载</th>
										<td>
											<input class="ui-input long80" name="register.qssd_kongzai" value="${register.qssd_kongzai}"/>
										</td>
										<th rowspan="2">最大下降速度(mm/s)</th>
										<th >空载</th>
										<td>
											<input class="ui-input long80" name="register.xjsd_kongzai" value="${register.xjsd_kongzai}"/>
										</td>
									</tr>
									<tr>
										<th >额定起重量</th>
										<td>
											<input class="ui-input long80" name="register.qssd_edingqizhongliang" value="${register.qssd_edingqizhongliang}"/>
										</td>
										<th >额定起重量</th>
										<td>
											<input class="ui-input long80" name="register.xjsd_edingqizhongliang" value="${register.xjsd_edingqizhongliang}"/>
										</td>
									</tr>
								</table>
					    		...
					    		<table class="tabjcxx" id="hzb" style="width: 80%">
					    			...
					    			<tr>
						    			<td>
						    				<input class="ui-input long98" inum="0" name="fjfj_list[${i.index}].xinghao" value="${c.xinghao}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98" inum="0" name="fjfj_list[${i.index}].mingcheng" value="${c.mingcheng}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98"  inum="0" name="fjfj_list[${i.index}].guige" value="${c.guige}"/>
						    			</td>
						    			<td>
						    				<input class="ui-input long98" inum="0" name="fjfj_list[${i.index}].zhizaochangjia" value="${c.zhizaochangjia}"/>
						    			</td>
						    			<td>
							...
							<div id="cclyggc" style="display: none;">
								...
								<table class="tabjcxx">
									...
									<tr>
										...
										<td>
											<input class="ui-input long80" name="register.zhengchezhiliang" value="${register.zhengchezhiliang}"/>kg
										</td>
										<th colspan="2">额定载客人数</th>
										<td>
											<input class="ui-input long80" name="register.edingzaikerenshu" value="${register.edingzaikerenshu}"/>
										</td>
									</tr>
									<tr>
										<th colspan="2">全长</th>
										<td>
											<input class="ui-input long80" name="register.chang" value="${register.chang}"/>mm
										</td>
										<th colspan="2">全宽</th>
										<td>
											<input class="ui-input long80" name="register.kuan" value="${register.kuan}"/>mm
										</td>
									</tr>
									<tr>
										<th colspan="2">全高</th>
										<td>
											<input class="ui-input long80" name="register.gao" value="${register.gao}"/>mm
										</td>
										<th colspan="2">最小离地间隙</th>
										<td>
											<input class="ui-input long80" name="register.jianxi" value="${register.jianxi}"/>mm
										</td>
									</tr>
									<tr>
										...
										<th >左</th>
										<td>
											<input class="ui-input long80" name="register.zhouju_zuo" value="${register.zhouju_zuo}"/>
										</td>
										<th rowspan="2">轮距（mm）</th>
										<th >前</th>
										<td>
											<input class="ui-input long80" name="register.lunju_qian" value="${register.lunju_qian}"/>
										</td>
									</tr>
									<tr>
										<th >右</th>
										<td>
											<input class="ui-input long80" name="register.zhouju_you" value="${register.zhouju_you}"/>
										</td>
										<th >后</th>
										<td>
											<input class="ui-input long80" name="register.lunju_hou" value="${register.lunju_hou}"/>
										</td>
									</tr>
									<tr>
										<th colspan="2">最小外侧转弯半径</th>
										<td>
											<input class="ui-input long80" name="register.banjing" value="${register.banjing}"/>mm
										</td>
										<th colspan="2">最大运行速度</th>
										<td>
											<input class="ui-input long80" name="register.sudu" value="${register.sudu}"/>km/h
										</td>
									</tr>
									<tr>
										<th colspan="2">最大行驶坡度</th>
										<td>
											<input class="ui-input long80" name="register.podu" value="${register.podu}"/>%
										</td>
										<th colspan="2">制动距离</th>
										<td>
											<input class="ui-input long80" name="register.zhidongjuli" value="${register.zhidongjuli}"/>m
										</td>
									</tr>
									<tr>
										<th colspan="2">发动机（电机）额定功率</th>
										...
										<td>
											<input class="ui-input long80" name="register.qianyin_zuoweishu" value="${register.qianyin_zuoweishu}"/>个
										</td>
									</tr>
									<tr>
										<th colspan="2">观光列车车厢数</th>
										<td>
											<input class="ui-input long80" name="register.liechechexiangshu" value="${register.liechechexiangshu}"/>节
										</td>
										<th colspan="2">观光列车每节车厢座位数</th>
										<td>
											<input class="ui-input long80" name="register.chexiangzuoweishu" value="${register.chexiangzuoweishu}"/>个
										</td>
									</tr>
								</table>
								<div style="width: 100%;text-align: center;font-size: 30px"><br/>
									...
									<tr>
										...
										<td>
										    <select id="cc_rlzl" name="register.ranliaozhonglei"  style="width: 195px;">
										    	<option value=""></option>
										    	<option value="柴油" ${register.ranliaozhonglei == "柴油" ? "selected":""}>柴油</option>
										    	<option value="汽油" ${register.ranliaozhonglei == "汽油" ? "selected":""}>汽油</option>
										    	<option value="天然气" ${register.ranliaozhonglei == "天然气" ? "selected":""}>天然气</option>
										    	<option value="液化石油气" ${register.ranliaozhonglei == "液化石油气" ? "selected":""}>液化石油气</option>
										    	<option value="蓄电池" ${register.ranliaozhonglei == "蓄电池" ? "selected":""}>蓄电池</option>
										    	<option value="混动:柴油、汽油" ${register.ranliaozhonglei == "混动：柴油、汽油" ? "selected":""}>混动：柴油、汽油</option>
										    	<option value="混动:柴油、天然气" ${register.ranliaozhonglei == "混动:柴油、天然气" ? "selected":""}>混动:柴油、天然气</option>
										    	<option value="混动:柴油、液化石油气" ${register.ranliaozhonglei == "混动:柴油、液化石油气" ? "selected":""}>混动:柴油、液化石油气</option>
										    	<option value="混动:柴油、蓄电池" ${register.ranliaozhonglei == "混动:柴油、蓄电池" ? "selected":""}>混动:柴油、蓄电池</option>
										    	<option value="混动:汽油、天然气" ${register.ranliaozhonglei == "混动:汽油、天然气" ? "selected":""}>混动:汽油、天然气</option>
										    	<option value="混动:汽油、液化石油气" ${register.ranliaozhonglei == "混动:汽油、液化石油气" ? "selected":""}>混动:汽油、液化石油气</option>
										    	<option value="混动:汽油、蓄电池" ${register.ranliaozhonglei == "混动:汽油、蓄电池" ? "selected":""}>混动:汽油、蓄电池</option>
										    	<option value="混动:天然气、液化石油气" ${register.ranliaozhonglei == "混动:天然气、液化石油气" ? "selected":""}>混动:天然气、液化石油气</option>
										    	<option value="混动:天然气、蓄电池" ${register.ranliaozhonglei == "混动:天然气、蓄电池" ? "selected":""}>混动:天然气、蓄电池</option>
										    	<option value="混动:液化石油气、蓄电池" ${register.ranliaozhonglei == "混动:液化石油气、蓄电池" ? "selected":""}>混动:液化石油气、蓄电池</option>
										    </select>
									    </td>
									</tr>
									<tr>
...
<script type="text/javascript" >
	...
	var tj = 0;
	$().ready(function(){
		showCpsjb("${register.shebeileibiedaima}","");
		...
		$("#hzb_add").click(function(){
			...
			tr += '<td><input class="ui-input " name="fjfj_list['+xxnum+'].mingcheng" /></td>';
