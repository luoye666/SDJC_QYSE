        ...
        <li class="tab_con">
    		...
    		<table class="tabjcxx" id="bj" style="width: 100%">
				...
				<tr>
					<th>是否在人口密集区</th>
					<td>
						<select class="long77" name="register.renkoumijiqu" id="rkmj">
							<option value=""></option>
					...
					<th >是否重大危险源</th>
					<td>
						<select class="long77" name="register.zhongdaweixianyuan" id="zdwx">
							<option value=""></option>
							<option value="是">是</option>
							<option value="否" selected="selected">否</option>
						</select>
				...
				<tr>
					<th>是否冷库设备</th>
					<td>
						<select class="long77" name="register.lengku" id="lengku">
							<option value=""></option>
							<option value="是">是</option>
							<option value="否" selected="selected">否</option>
						</select>
