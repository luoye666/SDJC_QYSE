							...
							<div id="zdftzdrxd_cw" style="display: none;">
								...
								<table class="tabjcxx">
									...
									<tr>
										...
										<th>出厂日期</th>
										<td>
											<input class="ui-input long98" name="register.chuchangriqi" onclick="WdatePicker()" value="<fmt:formatDate value='${register.chuchangriqi}' pattern='yyyy-MM-dd'/>" />
										</td>
									</tr>
									<tr>
										...
										<th>额定速度</th>
										<td>
											上行：<input class="ui-input" name="register.edingsudu_sx" value="${register.edingsudu_sx}" style="width: 70px" />m/s
											下行：<input class="ui-input" name="register.edingsudu_xx" value="${register.edingsudu_xx}" style="width: 70px" />m/s
										</td>
									</tr>
									<tr>
										<th colspan="2">额定载重量</th>
										<td>
											<input class="ui-input long80" name="register.edingzaizhongliang" value="${register.edingzaizhongliang}" />kg
										</td>
										<th>轿厢尺寸</th>
										<td>
											<input class="ui-input long80" name="register.jiaoxiangchicun" value="${register.jiaoxiangchicun}" />mm
										</td>
									</tr>
									<tr>
										<th colspan="2">提升高度</th>
										<td>
											<input class="ui-input long80" name="register.tishenggaodu" value="${register.tishenggaodu}" />m
										</td>
										<th>层/站/门数</th>
										<td>
											<input class="ui-input" name="register.ceng" value="${register.ceng}" style="width: 70px" />层
											<input class="ui-input" name="register.zhan" value="${register.zhan}" style="width: 70px" />站
											<input class="ui-input" name="register.men" value="${register.men}" style="width: 70px" />门
										</td>
									</tr>
									<tr>
										<th colspan="2">防爆型式</th>
										<td>
											<input class="ui-input long98" name="register.fangbaoxingshi" value="${register.fangbaoxingshi}" />
										</td>
										<th>防爆等级</th>
										<td>
											<input class="ui-input long98" name="register.fangbaodengji" value="${register.fangbaodengji}" />
										</td>
									</tr>
									<tr>
										...
										<td style="width: 30%">
											<input class="ui-input long80" name="register.qdzj_edinggonglv" value="${register.qdzj_edinggonglv}" />kW
										</td>
										<th style="width: 20%">额定转速</th>
										<td style="width: 30%">
											<input class="ui-input long80" name="register.qdzj_edingzhuansu" value="${register.qdzj_edingzhuansu}" />r/min
										</td>
									</tr>
									<tr>
										<th>减速比</th>
										<td colspan="3">
											<input class="ui-input long98" name="register.qdzj_jiansubi" value="${register.qdzj_jiansubi}" />
										</td>
									</tr>
									<tr>
										<th>液压泵站</th>
										...
										<td colspan="3">
											<input class="ui-input long80" name="register.yybz_gongzuoyali" value="${register.yybz_gongzuoyali}" />MPa
										</td>
									</tr>
									<tr>
										...
										<th>悬挂介质种类</th>
										<td>
											<input type="radio" name="register.xgxt_jiezhizhonglei" value="钢丝绳" ${register.xgxt_jiezhizhonglei == "钢丝绳" ? "checked" : "" } />钢丝绳
											<input type="radio" name="register.xgxt_jiezhizhonglei" value="复合带" ${register.xgxt_jiezhizhonglei == "复合带" ? "checked" : "" } />复合带
										</td>
										<th>悬挂介质数量</th>
										<td>
											<input class="ui-input long98" name="register.xgxt_jiezhishuliang" value="${register.xgxt_jiezhishuliang}" />
										</td>
									</tr>
									<tr>
										<th>悬挂介质型号</th>
										<td>
											<input class="ui-input long98" name="register.xgxt_jiezhixinghao" value="${register.xgxt_jiezhixinghao}" />
										</td>
										<th>悬挂介质规格</th>
										<td>
											<input class="ui-input long98" name="register.xgxt_jiezhiguige" value="${register.xgxt_jiezhiguige}" />
										</td>
									</tr>
									<tr>
										<th colspan="2">名称</th>
									...
									<tr>
										<td colspan="2">
											${d.mingcheng}
											<input type="hidden" name="fjfj_list[${i.index}].djbid" value="${d.djbid}" />
											<input type="hidden" name="fjfj_list[${i.index}].mingcheng" value="${d.mingcheng}" />
										</td>
										<td>
											<input class="ui-input long98" name="fjfj_list[${i.index}].xinghao" value="${d.xinghao}" />
										</td>
										<td>
											<input class="ui-input long98" name="fjfj_list[${i.index}].chanpinbianhao" value="${d.chanpinbianhao}" />
										</td>
										<td>
											<input class="ui-input long98" name="fjfj_list[${i.index}].zhizaochangjia" value="${d.zhizaochangjia}" />
										</td>
									</tr>
									</c:forEach>
								</table>
							...
							<div id="zdftzdrxd" style="display: none;">
								...
								<table class="tabjcxx">
									...
									<tr>
										...
										<td>
											<input class="ui-input long80" name="register.mingyisudu" value="${register.mingyisudu}" />m/s
										</td>
										<th>倾斜角</th>
										<td>
									...
									<tr>
										...
										<td>
											<input class="ui-input long80" name="register.mingyikuandu" value="${register.mingyikuandu}" />mm
										</td>
										<th>提升高度或使用区段长度</th>
										<td>
											<input class="ui-input long98" name="register.tishenggaodu" value="${register.tishenggaodu}" style="width: 70px" />m
										</td>
									</tr>
									<tr>
										<th colspan="2">工作环境</th>
										<td>
											<input class="ui-input long98" name="register.gongzuohuanjing" value="${register.gongzuohuanjing}" />
										</td>
										<th>工作类型</th>
										<td>
											<input type="radio" name="register.gongzuoleixing" value="公共交通型" ${register.gongzuoleixing == "公共交通型" ? "checked" : "" }/>公共交通型
											<input type="radio" name="register.gongzuoleixing" value="普通型" ${register.gongzuoleixing == "普通型" ? "checked" : "" } />普通型
										</td>
									</tr>
									<tr>
										...
										<td style="width: 30%">
											<input class="ui-input long98" name="register.qdzj_xinghao" value="${register.qdzj_xinghao}" />
										</td>
										<th style="width: 20%">产品编号</th>
										<td style="width: 30%">
											<input class="ui-input long98" name="register.qdzj_chanpinbianhao" value="${register.qdzj_chanpinbianhao}" />
										</td>
									</tr>
									<tr>
										<th>额定转速</th>
									...
									<tr>
										<th>制造单位</th>
										<td colspan="3">
											<input class="ui-input long98" name="register.qdzj_zhizaodanwei" value="${register.qdzj_zhizaodanwei}" />
										</td>
									</tr>
									<tr>
										<th rowspan="2">控制柜</th>
										<th>型号</th>
										<td>
											<input class="ui-input long98" name="register.kzg_xinghao" value="${register.kzg_xinghao}" />
										</td>
										<th>节能运行方式</th>
										<td>
											<input class="ui-input long98" name="register.kzg_yunxingfangshi" value="${register.kzg_yunxingfangshi}" />
										</td>
									</tr>
									<tr>
										<th>产品编号</th>
										<td>
											<input class="ui-input long98" name="register.kzg_chanpinbianhao" value="${register.kzg_chanpinbianhao}" />
										</td>
										<th>制造单位</th>
										<td>
											<input class="ui-input long98" name="register.kzg_zhizaodanwei" value="${register.kzg_zhizaodanwei}" />
										</td>
									</tr>
								</table>
							</div>
									...
									<tr>
										...
										<td>
											<select class="long98" name="register.shiyongchanghe" id="sych">
												<option value=""></option>
												<option value="住宅小区" ${register.shiyongchanghe=="住宅小区" ? "selected":""}>住宅小区</option>
												<option value="写字楼" ${register.shiyongchanghe=="写字楼" ? "selected":""}>写字楼</option>
												<option value="宾馆" ${register.shiyongchanghe=="宾馆" ? "selected":""}>宾馆</option>
												<option value="学校" ${register.shiyongchanghe=="学校" ? "selected":""}>学校</option>
												<option value="医院" ${register.shiyongchanghe=="医院" ? "selected":""}>医院</option>
												<option value="商场超市" ${register.shiyongchanghe=="商场超市" ? "selected":""}>商场超市</option>
												<option value="餐饮场所" ${register.shiyongchanghe=="餐饮场所" ? "selected":""}>餐饮场所</option>
												<option value="娱乐场所" ${register.shiyongchanghe=="娱乐场所" ? "selected":""}>娱乐场所</option>
												<option value="旅游景点" ${register.shiyongchanghe=="旅游景点" ? "selected":""}>旅游景点</option>
												<option value="厂区" ${register.shiyongchanghe=="厂区" ? "selected":""}>厂区</option>
												<option value="其他" ${register.shiyongchanghe=="其他" ? "selected":""}>其他</option>
											</select>
										</td>
									</tr>
									<tr>
...
<script type="text/javascript" language="javascript" for="window" event="onload">
	...
	$().ready(function(){
		...
		/**
		 * 青岛电梯应急平台使用 当预审通过或审核通过的时候使用
		 * @param {Object} data
		 * @param {Object} textStatus
		 */
		if("${register.shiyongdanweidizhi_shi_daima}" == "3702" && ("${register.tjstate}" == "1" || "${register.tjstate}" == "4")){
			$.dialog({
				title:'提示',
				lock: true,
			    width: '510px',
			    height: '120px',
			    content: '电梯注册登记已通过 ，为保证顺利领取96333电梯标志牌，' +
			    		 '请在向注册登记机关提交纸质材料时确保该电梯维保单位已将信息录入青岛市电梯信息管理系统 <a style="color:red;" href="http://120.221.95.1:8083/" target="view_window">（http://120.221.95.1:8083/）</a>'
			});
		}
			//生成级联下拉框
