...
<div>
	<form action="<%=path%>/register!addFujian.do?id=${param.id }" id="myForm" method="post" enctype="multipart/form-data">
	   
        <input type="file" name="uploadify" id="uploadify" accept="jpg"  style="width: 300px;" required="required">
        <span style="width:50px;color:red;">最大10m，如附件过大请压缩zip、rar格式</span><br/>
        <table>
			<tr>
