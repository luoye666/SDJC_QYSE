	...
	<form name="frm_jcsj_search_conditions" id="frm_jcsj_search_conditions">
	  	<table>
	  		<tr>
				<th>安装单位:</th>
				<td>
					<input  class="ui-input" style="width: 181px;" name="anzhuangdanwei" onkeyup="setInputValue(this)" id="azdw"/>
				</td>
				<th>机构代码:</th>
				<td>
					<input  class="ui-input" style="width: 181px;" name="jigoudaima" onkeyup="setInputValue(this)" id="jgdm"/>
				</td>
	  		</tr>
	  	</table>
	  </form>
