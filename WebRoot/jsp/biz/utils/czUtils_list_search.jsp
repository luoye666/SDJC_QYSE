	...
	<form name="frm_jcsj_search_conditions" id="frm_jcsj_search_conditions">
	  	<table style="width: 98%">
					<tr>
						<th>单位名称:</th>
						<td>
							<input  class="ui-input long90" style="width: 181px;" name="danweimingcheng" onkeyup="setInputValue(this)" id="dwmc"/>
						</td>
						<th>所在城市:</th>
						<td>
							<div id="sy_list_shi_div">
								<select  class="long90" name="shidaima" id="sy_list_shi"></select>
							</div>
						</td>
					</tr>
	  	</table>
