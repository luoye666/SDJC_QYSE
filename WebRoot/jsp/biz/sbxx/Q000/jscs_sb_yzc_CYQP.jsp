	    	...
	    	<div>
		    	<form id="frm_jcsj_sb_yzc_edit" method="post">
					...
					<legend>设备参数</legend>
						...
						<input class='ui-input' style="width: 176px;" name="qiping.gongzuoyali" value="${qiping.gongzuoyali}" oldValue="${qipingOld.gongzuoyali}"/>
						<br/>
						<label>容积(m3):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.rongji" value="${qiping.rongji}" oldValue="${qipingOld.rongji}"/>
						<label>总容积(m3):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.zongrongji" value="${qiping.zongrongji}" oldValue="${qipingOld.zongrongji}"/><br/>
						<label>车牌号:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.chepaihao" value="${qiping.chepaihao}" oldValue="${qipingOld.chepaihao}"/>
						<label>车辆VIN码:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.VINma" value="${qiping.VINma}" oldValue="${qipingOld.VINma}"/><br/>
						<label>产品标准:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.chanpinbiaozhu" value="${qiping.chanpinbiaozhu}" oldValue="${qipingOld.chanpinbiaozhu}"/>
						<label>额定质量(kg):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.edingzhiliang" value="${qiping.edingzhiliang}" oldValue="${qipingOld.edingzhiliang}"/><br/>
						<label>使用环境温度(℃):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.shiyongwendu" value="${qiping.shiyongwendu}" oldValue="${qipingOld.shiyongwendu}"/>
						<label>型  号:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.xinghao" value="${qiping.xinghao}" oldValue="${qipingOld.xinghao}"/><br/>
						<label>数  量:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.shuliang" value="${qiping.shuliang}" oldValue="${qipingOld.shuliang}"/>
						<label>气体置换后压力(MPa):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.qitizhihuanyali" value="${qiping.qitizhihuanyali}" oldValue="${qipingOld.qitizhihuanyali}"/><br/>
						<label>瓶体内含氧量(%):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.pingtihanyangliang" value="${qiping.pingtihanyangliang}" oldValue="${qipingOld.pingtihanyangliang}"/>
						<label>热处理方式:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.rechulifangshi" value="${qiping.rechulifangshi}" oldValue="${qipingOld.rechulifangshi}"/><br/>
						<label>热处理温度(℃):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.rechuliwendu" value="${qiping.rechuliwendu}" oldValue="${qipingOld.rechuliwendu}"/>
						<label>气瓶安装位置:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.qipinganzhuangweizhi" value="${qiping.qipinganzhuangweizhi}" oldValue="${qipingOld.qipinganzhuangweizhi}"/><br/>
						<hr/>
						<label>规  格</label>	<br/>
						
						<label>外径(mm):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.guige_waijing" value="${qiping.guige_waijing}" oldValue="${qipingOld.guige_waijing}"/>
						<label>壁厚(mm):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.guige_bihou" value="${qiping.guige_bihou}" oldValue="${qipingOld.guige_bihou}"/>
						<label>长度(mm):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.guige_changdu" value="${qiping.guige_changdu}" oldValue="${qipingOld.guige_changdu}"/><br/>
						<hr/>
						<label>材   料</label>	 <br/>
						<label>瓶体:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.cailiao_pingti" value="${qiping.cailiao_pingti}" oldValue="${qipingOld.cailiao_pingti}"/>
						<label>端塞:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.cailiao_duansai" value="${qiping.cailiao_duansai}" oldValue="${qipingOld.cailiao_duansai}"/>
						<label>管路:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.cailiao_guanlu" value="${qiping.cailiao_guanlu}" oldValue="${qipingOld.cailiao_guanlu}"/><br/>
						<hr/>
						<label>无损检测方法</label>	<br/>
						<label>气瓶:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.qiping_wsff" value="${qiping.qiping_wsff}" oldValue="${qipingOld.qiping_wsff}"/>
						<label>管路:</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.guanlu_wsff" value="${qiping.guanlu_wsff}" oldValue="${qipingOld.guanlu_wsff}"/>
						<hr/>
						<label>无损检测比例</label>	<br/>
						<label>气瓶(%):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.qiping_wsbl" value="${qiping.qiping_wsbl}" oldValue="${qipingOld.qiping_wsbl}"/>
						<label>管路(%):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.guanlu_wsbl" value="${qiping.guanlu_wsbl}" oldValue="${qipingOld.guanlu_wsbl}"/>
						<hr/>
						<label>耐压试验压力</label>	<br/>
						<label>气瓶(MPa):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.qiping_nysy" value="${qiping.qiping_nysy}" oldValue="${qipingOld.qiping_nysy}"/>
						<label>管路(MPa):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.guanlu_nysy" value="${qiping.guanlu_nysy}" oldValue="${qipingOld.guanlu_nysy}"/>
						<hr/>
						<label>气密性试验压力</label>	<br/>
						<label>气瓶(MPa):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.qiping_qmx" value="${qiping.qiping_qmx}" oldValue="${qipingOld.qiping_qmx}"/>
						<label>管路(MPa):</label>	
						<input class='ui-input' style="width: 176px;" name="qiping.guanlu_qmx" value="${qiping.guanlu_qmx}" oldValue="${qipingOld.guanlu_qmx}"/>
