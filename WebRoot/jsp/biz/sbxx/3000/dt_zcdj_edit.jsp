	   		...
	   		<div>
		    	<form id="frm_zcdj_edit${uuid}" method="post" enctype="multipart/form-data">
			    	...
			    	<div class="formHiddenRegion">
	                	 ...
	                	 <input type="hidden" name="register.shebeizhongleidaima" value="3000"/>
					...
					<div>
						<table class="tabjcxx">
							...
							<tr>
								...
								<th>检验类别</th>
								<td>
									<s:select style="width: 179px" id="jylb" name="register.jianyanleibie" list="#{'':'','定期检验':'定期检验','安装监检':'安装监检'}" value="register.jianyanleibie"></s:select>
								</td>
								<th>主要问题</th>
								<td>
		   			...
		   			<div>
		   				<table class="tabjcxx">
							...
							<tr>
								...
								<td colspan="2">
									<s:select style="width: 179px" id="rkmjq" name="register.renkoumijiqu" list="#{'':'','是':'是','否':'否'}" value="register.renkoumijiqu"></s:select>
								</td>
							</tr>
							<tr>
								<th>是否重大危险源</th>
								<td>
									<s:select style="width: 179px" id="zdwxy" name="register.zhongdaweixianyuan" list="#{'':'','是':'是','否':'否'}" value="register.zhongdaweixianyuan"></s:select>
								</td>
								<th colspan="4">是否制定事故应急措施和救援预案</th>
								<td>
									<s:select style="width: 179px" id="yjcs" name="register.yingjicuoshi" list="#{'':'','是':'是','否':'否'}" value="register.yingjicuoshi"></s:select>
								</td>
							</tr>
							<tr>
								<th></th>
								...
								<td>
									<s:select style="width: 179px" id="zdjk" name="register.zhongdianjiankong" list="#{'':'','是':'是','否':'否'}" value="register.zhongdianjiankong"></s:select>
								</td>
							</tr>
							<tr>
								<th>备注</th>
		   			...
		   			<div>
		   				<table class="tabjcxx">
							<tr>
								<th>管理方式</th>
								<td>
									<s:select style="width: 179px" id="glfs" name="register.guanlifangshi" list="#{'':'','常规管理':'常规管理','现代管理':'现代管理'}" value="register.guanlifangshi"></s:select>
								</td>
								<th>电梯运行速度（m/s）</th>
								<td>
	...
	*/
	$().ready(function(){
		if("${register.tjstate}" == "1" || "${register.tjstate}" == "2"){
			...
			//生成级联下拉框
			$.post("<%=path%>/dirList!getDataListByParentCodeForSe.do",{code:"3000"},
				function (data, textStatus){
				...
				var options = {
		            ...
		            success:function(rsp, statusText, xhr, $form){
		            	...
		            	if(rsp.msg == "SUCCESS"){
							...
							$.dialog.tips('<font color="blue">保存不成功!(技术参数是否非数字)</font>',3,'error.gif');
		            	}
		            }
		         };
