...
.xl108
 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="713.40" border="0" cellpadding="0" cellspacing="0" style='width:535.05pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="40" class="xl65" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl94" height="40" colspan="11" style='height:30.00pt;border-right:none;border-bottom:none;' x:str>非公路用旅游观光车辆产品数据表</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl153" height="30.67" colspan="4" style='height:23.00pt;mso-ignore:colspan;'></td>
    <td class="xl156" colspan="2" x:str>编号：</td>
    <td class="xl157" colspan="5" style='border-right:none;border-bottom:none;'></td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl158" height="32" colspan="2" style='height:24.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设备品种（名称）</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.shebeipinzhong }</td>
    <td class="xl158" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品型号</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.shebeixinghao }</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl158" height="30.67" colspan="2" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设备代码</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.shebeidaima }</td>
    <td class="xl158" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品编号</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.chuchangbianhao }</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl158" height="30.67" colspan="2" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>制造许可证编号</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhizaodanweixukezhengbianhao }</td>
    <td class="xl158" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>型式试验证书编号</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.shiyanzhengshubianhao }</td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl158" height="40" colspan="2" style='height:30.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>发动机<br/>（电机）编号</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.fadongjibianhao }</td>
    <td class="xl158" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>车架编号</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.chejiabianhao }</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl160" height="30.67" colspan="11" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;text-align: center;' x:str>主要参数</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl159" height="30.67" colspan="2" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>整机整备质量</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.zhengchezhiliang }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>kg</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>额定载客人数</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.edingzaikerenshu }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>名</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl159" height="30.67" colspan="2" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>全长</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.chang }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>mm</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>全宽</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.kuan }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>mm</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl159" height="30.67" colspan="2" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>全高</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.gao }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>mm</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>最小离地间隙</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.jianxi }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>mm</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl74" height="61.33" rowspan="2" style='height:46.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>轴距（mm）</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>左</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhouju_zuo }</td>
    <td class="xl74" rowspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>轮距（mm）</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;' x:str>前</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.lunju_qian }</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>右</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhouju_you }</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;' x:str>后</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.lunju_hou }</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl74" height="30.67" colspan="2" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>最小外侧转弯半径</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.banjing }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>mm</td>
    <td class="xl74" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>最大运行速度</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.sudu }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>km/h</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl74" height="30.67" colspan="2" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>最大行驶坡度</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.podu }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>%</td>
    <td class="xl159" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>制动距离</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.zhidongjuli }</td>
    <td class="xl159" style='border:.5pt solid windowtext;'x:str>m</td>
   </tr>
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    <td class="xl74" height="52" colspan="2" style='height:39.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>发动机（电机）<br/>额定功率</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.fadongjiedinggonglv }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>kW</td>
    <td class="xl74" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>观光列车牵引车头座位数</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.qianyin_zuoweishu }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>个</td>
   </tr>
   <tr height="46.67" style='height:35.00pt;mso-height-source:userset;mso-height-alt:700;'>
    <td class="xl74" height="46.67" colspan="2" style='height:35.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>观光列车车厢数</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;' >${craneParam.liechechexiangshu }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>节</td>
    <td class="xl74" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>观光列车每节车厢座位数</td>
    <td class="xl159" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.chexiangzuoweishu }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>个</td>
   </tr>
  </table>
 </body>
