...
.xl108
 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="713.40" border="0" cellpadding="0" cellspacing="0" style='width:535.05pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="40" class="xl65" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl94" height="40" colspan="11" style='height:30.00pt;border-right:none;border-bottom:none;' x:str>大型游乐设施产品数据表</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl164" height="32" colspan="5" style='height:24.00pt;mso-ignore:colspan;'></td>
    <td class="xl166" colspan="2" style='border-right:none;border-bottom:none;' x:str>编号：</td>
    <td class="xl167" colspan="4" style='border-right:none;border-bottom:none;'></td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" height="32" colspan="2" style='height:24.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品名称</td>
    <td class="xl168" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${recreat.shebeimingcheng }</td>
    <td class="xl168" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设备品种</td>
    <td class="xl169" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${recreat.shebeipinzhong }</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" height="32" colspan="2" style='height:24.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品标准</td>
    <td class="xl168" colspan="4" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'></td>
    <td class="xl168" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品编号</td>
    <td class="xl169" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${recreat.chuchangbianhao }</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" height="32" colspan="2" style='height:24.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设备代码</td>
    <td class="xl168" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${recreat.shebeidaima }</td>
    <td class="xl168" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设计使用年限</td>
    <td class="xl169" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${recreat.shebeishiyongnianxian }</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" height="32" colspan="2" style='height:24.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设备级别</td>
    <td class="xl168" colspan="4" style='border:.5pt solid windowtext;'>${recreat.shebeijibie }</td>
    <td class="xl168" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设备使用方式</td>
    <td class="xl169" colspan="3" style='border:.5pt solid windowtext;border-bottom:none;'>${recreat.shiyongfangshi }</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" height="256" rowspan="8" style='height:192.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主要参数</td>
    <td class="xl168" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>运行速度</td>
    <td class="xl171" colspan="2" style='border:.5pt solid windowtext;'>${recreat.sudu }</td>
    <td class="xl172" style='border:.5pt solid windowtext;' x:str>km/h</td>
    <td class="xl173" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>转速</td>
    <td class="xl169" colspan="2"  style='border:.5pt solid windowtext;'>${recreat.zhuansu }</td>
    <td class="xl172" style='border:.5pt solid windowtext;' x:str>rpm</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>运行高度</td>
    <td class="xl171" colspan="2" style='border:.5pt solid windowtext;'>${recreat.gaodu }</td>
    <td class="xl174" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl74" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>回转直径（静止）</td>
    <td class="xl169" colspan="2" style='border:.5pt solid windowtext;'>${recreat.huizhuanzhijing}</td>
    <td class="xl174" style='border:.5pt solid windowtext;' x:str>m</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:980;'>
    <td class="xl74" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>每车承载人数<br/>或每列承载人数<br/>或每舱承载人数</td>
    <td class="xl171" colspan="2" style='border:.5pt solid windowtext;'>${recreat.cheliangshu}</td>
    <td class="xl172" style='border:.5pt solid windowtext;' x:str>人</td>
    <td class="xl173" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>车辆数</td>
    <td class="xl169" colspan="2" style='border:.5pt solid windowtext;'>${recreat.cheliangshu}</td>
    <td class="xl172" style='border:.5pt solid windowtext;' x:str>人</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>或每列承载人数</td>
    <td class="xl171" colspan="2" style='border:.5pt solid windowtext;'>${recreat.cheliangshu}</td>
    <td class="xl174" style='border:.5pt solid windowtext;' x:str>人</td>
    <td class="xl173" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>或列车数</td>
    <td class="xl169" colspan="2" style='border:.5pt solid windowtext;'>${recreat.cheliangshu}</td>
    <td class="xl174" style='border:.5pt solid windowtext;' x:str>人</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>或每舱承载人数</td>
    <td class="xl171" colspan="2" style='border:.5pt solid windowtext;'>${recreat.cheliangshu}</td>
    <td class="xl172" style='border:.5pt solid windowtext;' x:str>人</td>
    <td class="xl173" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>或座舱数</td>
    <td class="xl169" colspan="2" style='border:.5pt solid windowtext;'>${recreat.cheliangshu}</td>
    <td class="xl172" style='border:.5pt solid windowtext;' x:str>人</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>轨道高度</td>
    <td class="xl171" colspan="2" style='border:.5pt solid windowtext;'>${recreat.guidaogaodu}</td>
    <td class="xl174" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl173" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>高差</td>
    <td class="xl169" colspan="2" style='border:.5pt solid windowtext;'>${recreat.gaocha}</td>
    <td class="xl174" style='border:.5pt solid windowtext;' x:str>m</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>单侧摆角</td>
    <td class="xl171" colspan="2" style='border:.5pt solid windowtext;'></td>
    <td class="xl172" style='border:.5pt solid windowtext;' x:str>°</td>
    <td class="xl173" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>最大坡度</td>
    <td class="xl169" colspan="2" style='border:.5pt solid windowtext;'></td>
    <td class="xl172" style='border:.5pt solid windowtext;' x:str>°</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl168" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设计最大加速度</td>
    <td class="xl171" colspan="2" style='border:.5pt solid windowtext;'>${recreat.shejijiasudu}</td>
    <td class="xl172" style='border:.5pt solid windowtext;' x:str>G</td>
    <td class="xl173" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'></td>
    <td class="xl169" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'></td>
   </tr>
   <tr height="90.67" style='height:68.00pt;mso-height-source:userset;mso-height-alt:1360;'>
    <td class="xl74" height="90.67" style='border:.5pt solid windowtext;height:68.00pt;' x:str>主要结构和运动形式描述</td>
    <td class="xl175" colspan="10" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'></td>
   </tr>
  </table>
 </body>
</html>
