...
.xl108
 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="713.40" border="0" cellpadding="0" cellspacing="0" style='width:535.05pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="40" class="xl65" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl94" height="40" colspan="11" style='height:30.00pt;border-right:none;border-bottom:none;' x:str>缆索式起重机产品数据表</td>
   </tr>
   ...
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <td class="xl182" height="26.67" colspan="11" style='height:20.00pt;border:.5pt solid windowtext;text-align: center;' x:str>主要参数和用途</td>
   </tr>
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <td class="xl161" height="26.67" colspan="3" style='height:20.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>额定起重量</td>
    <td class="xl212" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.edingqizhongliang }</td>
    <td class="xl207" style='border:.5pt solid windowtext;'x:str>t</td>
    <td class="xl188" colspan="3" style='border:.5pt sborderext;border-bottom:.5pt solid windowtext;' x:str>幅<span style='mso-spacerun:yes;'>&nbsp; </span>度</td>
    <td class="xl185" style='border:.5pt solid windowtext;'>${craneParam.kuadu }</td>
   ...
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    ...
    <td class="xl212" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.gongzuojibie }</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>吊具最高高度</td>
    <td class="xl185" style='border:.5pt solid windowtext;'>${craneParam.diaojuzuigaogaodu }</td>
    <td class="xl204" style='border:.5pt solid windowtext;' x:str>m</td>
   </tr>
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <td class="xl161" height="26.67" colspan="3" style='height:20.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>承载索垂度</td>
    <td class="xl212" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.chengzaisuochuidu }</td>
    <td class="xl204" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl188" colspan="3" style='border:.5pt sborderext;border-bottom:.5pt solid windowtext;' x:str>吊具最低高度</td>
    <td class="xl210" style='border:.5pt solid windowtext;'>${craneParam.diaojuzuidigaodu }</td>
    <td class="xl207" style='border:.5pt solid windowtext;' x:str>m</td>
   </tr>
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <td class="xl161" height="26.67" colspan="3" style='height:20.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>承载索型号</td>
    <td class="xl212" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.chengzaisuoxinghao }</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>牵引索型号</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.qianyinsuoxinghao }</td>
   </tr>
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <td class="xl161" height="26.67" colspan="3" style='height:20.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>安装高程</td>
    <td class="xl212" colspan="2" style='border:none;border:.5pt solid windowtext;'>${craneParam.anzhuanggaocheng }</td>
    <td class="xl204" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl188" colspan="3" style='border-borderolid windowtext;border-bottom:.5pt solid windowtext;' x:str>垂跨比</td>
    <td class="xl189" style='border:.5pt solid windowtext;'>${craneParam.chuikuabi }</td>
    <td class="xl190" style='border:.5pt solid windowtext;' x:str>%</td>
   </tr>
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <td class="xl161" height="26.67" colspan="3" style='height:20.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>回转范围</td>
    <td class="xl212" colspan="2" style='border:none;border-bottom:.5pt solid windowtext;'>${craneParam.huizhuanfanwei }</td>
    <td class="xl186" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>整机设计重量</td>
    <td class="xl185">${craneParam.zhengchezhongliang }</td>
    <td class="xl204" style='border:.5pt solid windowtext;' x:str>t</td>
   </tr>
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <td class="xl161" height="26.67" colspan="3" style='height:20.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>整机功率</td>
    <td class="xl212" colspan="2" style='border:none;border-bottom:.5pt solid windowtext;'>${craneParam.zhengjigonglv }</td>
   ...
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <td class="xl161" height="26.67" colspan="3" style='height:20.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>工作环境温度</td>
    <td class="xl212" colspan="2" style='border:none;border-bottom:.5pt solid windowtext;'>${craneParam.gongzuowendu }</td>
   ...
   <tr height="26.67" style='height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <td class="xl184" height="26.67" colspan="3" style='height:20.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主体结构型式</td>
