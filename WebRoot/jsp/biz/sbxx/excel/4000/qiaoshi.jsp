...
.xl108
 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="713.40" border="0" cellpadding="0" cellspacing="0" style='width:535.05pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="40" class="xl65" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl94" height="40" colspan="11" style='height:30.00pt;border-right:none;border-bottom:none;' x:str>桥式起重机产品数据表</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl157" height="28" colspan="5" style='height:21.00pt;mso-ignore:colspan;'></td>
    <td class="xl159" colspan="2" style='border-right:none;border-bottom:none;' x:str>编号：</td>
    <td class="xl157" colspan="4"></td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl160" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品品种</td>
    <td class="xl161" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' >${craneParam.shebeipinzhong }</td>
    <td class="xl160" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品总图图号</td>
    <td class="xl160" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.chanpintuhao }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl160" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>整机制造标准</td>
    <td class="xl160" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhizaobiaozhun }</td>
    <td class="xl160" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设计使用年限</td>
    <td class="xl162" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' >${craneParam.shebeishiyongnianxian }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl160" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>型式试验机构</td>
    <td class="xl161" colspan="9" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' >${craneParam.shiyanjigou }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl160" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>型式试验日期</td>
    <td class="xl160" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.shiyanriqi }</td>
    <td class="xl160" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>型式试验证书编号</td>
    <td class="xl160" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.shiyanzhengshubianhao }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl163" height="28" colspan="11" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;text-align: center;' x:str>主要参数和用途</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl165" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>额定起重量</td>
    <td class="xl165" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.edingqizhongliang }</td>
    <td class="xl160" style='border:.5pt solid windowtext;' x:str>t</td>
    <td class="xl165" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>起升速度</td>
    <td class="xl165" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.qishengsudu }</td>
    <td class="xl160" style='border:.5pt solid windowtext;' x:str>m/min</td>
   </tr>
   <tr height="28" class="xl157" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl165" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;' x:str>起升高度</td>
    <td class="xl160" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.qishenggaodu }</td>
    <td class="xl160" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl165" colspan="3" style='border:none;border-bottom:.5pt solid windowtext;' x:str>大车运行速度</td>
    <td class="xl165" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.dacheyunxingsudu }</td>
    <td class="xl160" style='border:.5pt solid windowtext;' x:str>m/min</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl165" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>小车运行速度</td>
    <td class="xl165" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.xiaocheyunxingsudu }</td>
    <td class="xl160" style='border:.5pt solid windowtext;' x:str>m/min</td>
    <td class="xl165" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>跨度</td>
    <td class="xl165" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.kuadu }</td>
    <td class="xl160" style='border:.5pt solid windowtext;' x:str>m</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl165" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>工作级别</td>
    <td class="xl165" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.gongzuojibie }</td>
    <td class="xl165" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>整机功率</td>
    <td class="xl165" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhengjigonglv }</td>
    <td class="xl160" style='border:.5pt solid windowtext;' x:str>kW</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl165" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>整机设计重量</td>
    <td class="xl165" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhengchezhongliang }</td>
    <td class="xl160" style='border:.5pt solid windowtext;' x:str>t</td>
    <td class="xl165" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>工作环境温度</td>
    <td class="xl165" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.gongzuowendu }</td>
    <td class="xl160" style='border:.5pt solid windowtext;' x:str><span style='mso-spacerun:yes;'>&nbsp;</span>℃</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl163" height="28" colspan="11" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主要结构型式</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl160" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主梁型式</td>
    <td class="xl160" colspan="8" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhuliangxingshi }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl160" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主要受力结构件材料</td>
    <td class="xl164" colspan="8" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.shoulijiegoucailiao }</td>
   </tr>
