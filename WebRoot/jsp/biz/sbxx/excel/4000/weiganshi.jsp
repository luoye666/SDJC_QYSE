...
.xl108
 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="713.40" border="0" cellpadding="0" cellspacing="0" style='width:535.05pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="40" class="xl65" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl94" height="40" colspan="11" style='height:30.00pt;border-right:none;border-bottom:none;' x:str>桅杆式起重机产品数据表</td>
   </tr>
   ...
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品品种</td>
    ...
    <td class="xl161" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品型号</td>
    <td class="xl161" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.shebeixinghao }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>整机制造标准</td>
   ...
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>型式试验机构</td>
    <td class="xl161" colspan="9" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' >${craneParam.shiyanjigou }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>型式试验日期</td>
   ...
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主钩最大额定起重量</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhugouzuidaliang }</td>
    <td class="xl186" style='border:.5pt solid windowtext;' x:str>t</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>副钩最大额定起重量</td>
    <td class="xl185" style='border:.5pt solid windowtext;'>${craneParam.fugouzuidaliang }</td>
    <td class="xl186" style='border:.5pt solid windowtext;' x:str>t</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主钩最大工作幅度</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.zhugouzuidafudu }</td>
    <td class="xl204" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>副钩最大工作幅度</td>
    <td class="xl185" style='border:.5pt solid windowtext;'>${craneParam.fugouzuidafudu }</td>
    <td class="xl204" style='border:.5pt solid windowtext;'x:str>m</td>
   </tr>
   <tr height="44" style='height:33.00pt;mso-height-source:userset;mso-height-alt:660;'>
    <td class="xl74" height="44" colspan="3" style='height:33.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主钩最大工作幅度时的额定起重量</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.zhugouzuidafuduliang }</td>
    <td class="xl186" style='border:.5pt solid windowtext;'x:str>t</td>
    <td class="xl74" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>副钩最大工作幅度时的额定起重量</td>
    <td class="xl185" style='border:.5pt solid windowtext;'>${craneParam.fugouzuidafuduliang }</td>
    <td class="xl186" style='border:.5pt solid windowtext;' x:str>t</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主钩最大起升高度</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.zhugouzuidagaodu }</td>
    <td class="xl204" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>副钩最大起升高度</td>
    <td class="xl185" style='border:.5pt solid windowtext;'>${craneParam.fugouzuidagaodu }</td>
    <td class="xl204" style='border:.5pt solid windowtext;' x:str>m</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主钩起升速度</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.zhugouqishengsudu }</td>
    <td class="xl186" style='border:.5pt solid windowtext;' x:str>m/min</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>副钩起升速度</td>
    <td class="xl185" style='border:.5pt solid windowtext;' >${craneParam.fugouqishengsudu }</td>
    <td class="xl186" style='border:.5pt solid windowtext;' x:str>m/min</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>回转角度</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.huizhuanjiaodu }</td>
    <td class="xl204" style='border:.5pt solid windowtext;' x:str>°</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>行走范围</td>
    <td class="xl210" style='border:.5pt solid windowtext;' >${craneParam.xingzoufanwei }</td>
    <td class="xl204" style='border:.5pt solid windowtext;' x:str>m</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>行走速度</td>
    <td class="xl195" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.xingzousudu }</td>
    <td class="xl207" style='border:.5pt solid windowtext;' x:str>m/min</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主调速方式</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhutiaosufengshi }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    ...
    <td class="xl189" style='border:.5pt solid windowtext;'>${craneParam.zhengchezhongliang }</td>
    <td class="xl186" style='border:.5pt solid windowtext;' x:str>t</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>整机功率</td>
    <td class="xl199" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.zhengjigonglv }</td>
    <td class="xl190" style='border:.5pt solid windowtext;' x:str>kW</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>供电电源</td>
    <td class="xl185" style='border:.5pt solid windowtext;'>${craneParam.gongdiandianyuan }</td>
    <td class="xl186" style='border:.5pt solid windowtext;' x:str>V</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>工作环境温度</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;'>${craneParam.gongzuowendu }</td>
    <td class="xl186" style='border:.5pt solid windowtext;' x:str>℃</td>
    <td class="xl188" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>其它</td>
    <td class="xl184" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.qita }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
   ...
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl184" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主体结构型式</td>
    <td class="xl193" colspan="8" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.zhutijiegouxingshi }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl161" height="28" colspan="3" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主要受力结构件材料</td>
    <td class="xl209" colspan="8" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${craneParam.shoulijiegoucailiao }</td>
   </tr>
  </table>
 </body>
</html>
