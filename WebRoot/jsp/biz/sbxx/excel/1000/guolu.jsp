...
.xl108
    ...
    <x:ExcelWorkbook>
     <x:ExcelWorksheets>
      <x:ExcelWorksheet>
       ...
       <x:DataValidation>
        <x:Range>$E$44:G44</x:Range>
        <x:Type>List</x:Type>
        <x:CellRangeList/>
        <x:Value>&quot;钢丝绳,复合带&quot;</x:Value>
       </x:DataValidation>
      </x:ExcelWorksheet>
     </x:ExcelWorksheets>
 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="713.40" border="0" cellpadding="0" cellspacing="0" style='width:535.05pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="40" class="xl65" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl94" height="40" colspan="11" style='height:30.00pt;border-right:none;border-bottom:none;' x:str>锅炉产品数据表</td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl145" height="40" colspan="2" style='height:30.00pt;mso-ignore:colspan;'></td>
    <td class="xl148" colspan="3" style='mso-ignore:colspan;'></td>
    <td class="xl149" x:str>编号：</td>
    <td class="xl145" colspan="3"></td>
    <td class="xl145"></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl150" height="40" colspan="2" style='height:30.00pt;border:.5pt solid windowtext;' x:str>设备类别</td>
    <td class="xl151" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.shebeileibie }</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;' x:str>产品名称</td>
    <td class="xl151" colspan="3" style='border:.5pt solid windowtext;'>${boilerParam.shebeimingcheng }</td>
    <td class="xl145"></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl151" height="40" colspan="2" style='height:30.00pt;border:.5pt solid windowtext;' x:str>产品型号</td>
    <td class="xl151" colspan="4" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.shebeixinghao }</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;' x:str>产品编号</td>
    <td class="xl151" colspan="3" style='border:.5pt solid windowtext;'>${boilerParam.chuchangbianhao }</td>
    <td class="xl145"></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl151" height="40" colspan="2" style='height:30.00pt;border:.5pt solid windowtext;' x:str>设备代码</td>
    <td class="xl151" colspan="4" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.shebeidaima }</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;' x:str>设备级别</td>
    <td class="xl151" colspan="3" style='border:.5pt solid windowtext;'>${boilerParam.shebeijibie }</td>
    <td class="xl145"></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl151" height="80" rowspan="2" style='height:60.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设计情况</td>
    <td class="xl151" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设计文件鉴定日期</td>
    <td class="xl151" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.wenjianjiandingriqi }</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;' x:str>鉴定报告书编号</td>
    <td class="xl151" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.jiandingbaogaobianhao }</td>
    <td class="xl145"></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl151" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>鉴定机构名称</td>
    <td class="xl151" colspan="8" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.jiandingjigou}</td>
    <td class="xl145"></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl151" height="304" rowspan="7" style='height:228.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主要参数</td>
    <td class="xl74" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>额定蒸发量（热功率）</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;'>${boilerParam.edingzhengfaliang }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>t/h</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;' x:str>额定工作压力</td>
    <td class="xl151" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.edingyali }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>MPa</td>
    <td class="xl145"></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>额定工作温度</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;'>${boilerParam.edingwendu }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>℃</td>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;' x:str>设计热效率</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.shejireciaolv }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>%</td>
    <td class="xl145"></td>
   </tr>
   <tr height="60" style='height:68.00pt;mso-height-source:userset;mso-height-alt:960;'>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>给水温度</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;'>${boilerParam.geishuiwendu }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>℃</td>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;' x:str>额定出水（油）/回水（油）温度</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;'>${boilerParam.edingchushui }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>℃</td>
    <td class="xl145"></td>
   </tr>
   <tr height="60" style='height:68.00pt;mso-height-source:userset;mso-height-alt:960;'>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>锅炉本体水（油）容积</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;'>${boilerParam.rongji }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>L</td>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;' x:str>整装锅炉本体液压试验介质/压力</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;'>${boilerParam.bentijiezhi }/${boilerParam.bentiyali }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>MPa</td>
    <td class="xl145"></td>
   </tr>
   <tr height="64" style='height:68.00pt;mso-height-source:userset;mso-height-alt:960;'>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>再热器进（出）口温度(℃)</td>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;'>${boilerParam.jinkouwendu }</td>
    <td class="xl74" style='border:.5pt solid windowtext;' >℃</td>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;' >再热器进（出）口压力</td>
    <td class="xl74" colspan="2"style='border:.5pt solid windowtext;'>${boilerParam.chukouyali}</td>
    <td class="xl74" style='border:.5pt solid windowtext;' x:str>MPa</td>
    <td class="xl145"></td>
   </tr>
   <tr height="60" style='height:50.00pt;mso-height-source:userset;mso-height-alt:960;'>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>再热蒸汽流量</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;'>${boilerParam.zhengqiliuliang }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>t/h</td>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;' x:str>有机热载体锅炉气密试验介质/压力</td>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;'>${boilerParam.qimijiezhi }/${boilerParam.qimiyali }</td>
    <td class="xl151" style='border:.5pt solid windowtext;' x:str>MPa</td>
    <td class="xl145"></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl151" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>燃烧方式</td>
    <td class="xl151" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.ranshaofangshi }</td>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;' x:str>燃料（或者热源）种类</td>
    <td class="xl151" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.ranliaozhonglei }</td>
    <td class="xl145"></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl74" height="80" rowspan="2" style='height:60.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>制造监检情况</td>
    <td class="xl156" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>监检机构</td>
    <td class="xl156" colspan="8" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.zhizaojianjianjigou }</td>
    <td></td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl156" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>机构组织代码</td>
    <td class="xl156" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'></td>
    <td class="xl157" colspan="2" style='border:.5pt solid windowtext;' x:str>机构核准证编号</td>
    <td class="xl156" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${boilerParam.jianjianzhengshubianhao }</td>
    <td></td>
   </tr>
