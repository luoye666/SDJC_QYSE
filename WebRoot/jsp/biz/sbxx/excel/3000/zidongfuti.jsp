...
.xl108
 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="713.40" border="0" cellpadding="0" cellspacing="0" style='width:535.05pt;border-collapse:collapse;table-layout:fixed;text-align: center;'>
   ...
   <tr height="40" class="xl65" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl94" height="40" colspan="11" style='height:30.00pt;border-right:none;border-bottom:none;' x:str>电梯产品数据表（适用于自动扶梯与自动人行道）</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl155" height="32" colspan="2" style='height:24.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品品种</td>
    <td class="xl156" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>${elevatorPraram.shebeipinzhong }</td>
    <td class="xl155" colspan="2" style='border:.5pt solid windowtext;' x:str>产品名称</td>
    <td class="xl156" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.shebeimingcheng }</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl155" height="32" colspan="2" style='height:24.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>名义速度</td>
    <td class="xl158" colspan="3"  style='border:.5pt solid windowtext;'>${elevatorPraram.mingyisudu }</td>
    <td class="xl158" style='border:.5pt solid windowtext;' x:str>m/s</td>
    <td class="xl155" colspan="2" style='border:.5pt solid windowtext;' x:str>倾斜角</td>
    <td class="xl158" colspan="2" style='border:.5pt solid windowtext;'>${elevatorPraram.qingxiejiao }</td>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    <td class="xl155" height="52" colspan="2" style='height:39.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>名义宽度</td>
    <td class="xl156" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.mingyikuandu }</td>
    <td class="xl74" colspan="2" style='border:.5pt solid windowtext;' x:str>提升高度或使用区段长度</td>
    <td class="xl155" colspan="2" style='border:.5pt solid windowtext;'>${elevatorPraram.tishenggaodu }/${elevatorPraram.quduanchangdu }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>m</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl155" height="32" colspan="2" style='height:24.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>工作环境</td>
    <td class="xl156" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.gongzuohuanjing }</td>
    <td class="xl155" colspan="2" style='border:.5pt solid windowtext;' x:str>工作类型</td>
    <td class="xl156" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.gongzuoleixing }</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl160" height="96" rowspan="3" style='height:72.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>驱动主机</td>
    <td class="xl155" style='border:.5pt solid windowtext;' x:str>型号</td>
    <td class="xl156" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.qudong_xinghao }</td>
    <td class="xl155" colspan="2" style='border:.5pt solid windowtext;' x:str>产品编号</td>
    <td class="xl156" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.qudong_chanpinbianhao }</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl155" style='border:.5pt solid windowtext;' x:str>额定转速</td>
    <td class="xl158" colspan="3" style='border:.5pt solid windowtext;'>${elevatorPraram.qudong_edingzhuansu}</td>
    <td class="xl158" style='border:.5pt solid windowtext;' x:str>r/min</td>
    <td class="xl155" colspan="2" style='border:.5pt solid windowtext;' x:str>额定功率</td>
    <td class="xl158" colspan="2" style='border:.5pt solid windowtext;'>${elevatorPraram.qucong_edinggonglv }</td>
    <td class="xl159" style='border:.5pt solid windowtext;' x:str>kW</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl155" style='border:.5pt solid windowtext;' x:str>制造单位</td>
    <td class="xl156" colspan="9" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.qudong_zhizaodanwei }</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl155" height="64" rowspan="2" style='height:48.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>控制柜</td>
    <td class="xl155" style='border:.5pt solid windowtext;' x:str>型号</td>
    <td class="xl156" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.kongzhi_xinghao }</td>
    <td class="xl155" colspan="2" style='border:.5pt solid windowtext;' x:str>节能运行方式</td>
    <td class="xl156" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.kongzhi_yunxingfangshi }</td>
   </tr>
   <tr height="32" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
    <td class="xl155" style='border:.5pt solid windowtext;' x:str>产品编号</td>
    <td class="xl156" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.kongzhi_chanpinbianhao}</td>
    <td class="xl155" colspan="2" style='border:.5pt solid windowtext;' x:str>制造单位</td>
    <td class="xl156" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.kongzhi_zhizaodanwei }</td>
   </tr>
