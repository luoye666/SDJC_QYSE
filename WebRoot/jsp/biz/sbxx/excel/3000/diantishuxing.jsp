...
.xl108
 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="717.40" border="0" cellpadding="0" cellspacing="0" style='width:535.05pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="28" class="xl65" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    ...
    <td class="xl73" colspan="8" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>${baseInfo.chanquandanwei_dizhi }</td>
   </tr>
   <tr height="32" class="xl65" style='height:24.00pt;mso-height-source:userset;mso-height-alt:480;'>
   ...
   <tr height="40" class="xl65" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl94" height="40" colspan="11" style='height:30.00pt;border-right:none;border-bottom:none;' x:str>电梯产品数据表（自动扶梯与自动人行道除外）</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl166" height="28" colspan="2" style='height:21.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品品种</td>
    <td class="xl166" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.shebeipinzhong }</td>
    <td class="xl166" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品名称</td>
    <td class="xl166" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.shebeimingcheng }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl166" height="28" colspan="2" style='height:21.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>出厂编号</td>
    <td class="xl166" colspan="4" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.chuchangbianhao }</td>
    <td class="xl166" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>出厂日期</td>
    <td class="xl180" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.zhizaoriqi }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl167" height="56" colspan="2" rowspan="2" style='height:42.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品型号</td>
    <td class="xl167" colspan="4" rowspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.shebeixinghao }</td>
    <td class="xl74" rowspan="2" style='border-right:none;border-bottom:.5pt solid windowtext;' x:str>额定速度</td>
    <td class="xl166" style='border:.5pt solid windowtext;' x:str>上行</td>
    <td class="xl166" colspan="2" style='border:.5pt solid windowtext;' x:str>${elevatorPraram.edingsudu_shangxing }</td>
    <td class="xl166" style='border:.5pt solid windowtext;' x:str>m/s<span style='mso-spacerun:yes;'>&nbsp;</span></td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl166" style='border:.5pt solid windowtext;' x:str>下行</td>
    <td class="xl166" colspan="2" style='border:.5pt solid windowtext;'>${elevatorPraram.edingsudu_xiaxing }</td>
    <td class="xl166" style='border:.5pt solid windowtext;' x:str>m/s<span style='mso-spacerun:yes;'>&nbsp;</span></td>
   </tr>
   <tr height="45.33" style='height:34.00pt;mso-height-source:userset;mso-height-alt:680;'>
    <td class="xl166" height="45.33" colspan="2" style='height:34.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>额定载重量</td>
    <td class="xl173" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>${elevatorPraram.edingzaizhongliang }</td>
    <td class="xl166" style='border:.5pt solid windowtext;' x:str><span style='mso-spacerun:yes;'>&nbsp;</span>kg</td>
    <td class="xl166" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>轿厢尺寸</td>
    <td class="xl166" colspan="2" style='border:.5pt solid windowtext;' x:str>${elevatorPraram.jiaoxiangchicui }</td>
    <td class="xl166" style='border:.5pt solid windowtext;' x:str>mm</td>
   </tr>
   <tr height="44" style='height:33.00pt;mso-height-source:userset;mso-height-alt:660;'>
    <td class="xl166" height="44" colspan="2" style='height:33.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>提升高度</td>
    <td class="xl173" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.tishenggaodu }</td>
    <td class="xl166" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl74"  colspan="2" style='border:.5pt solid windowtext;' x:str>层/站/门数</td>
    <td class="xl166" colspan="3" style='border:.5pt solid windowtext;'>${elevatorPraram.ceng }/${elevatorPraram.zhan }/${elevatorPraram.men }</td>
   </tr>
   <tr height="45.33" style='height:34.00pt;mso-height-source:userset;mso-height-alt:680;'>
    <td class="xl74" height="45.33" colspan="2" style='height:34.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>防爆型式(适用于防爆电梯)</td>
    <td class="xl166" colspan="4" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.fangbaoxingshi }</td>
    <td class="xl74" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>防爆等级(适用于防爆电梯)</td>
    <td class="xl166" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.fangbaodengji }</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl166" height="56" rowspan="2" style='height:42.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>驱动主机</td>
    <td class="xl166" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>额定功率</td>
    <td class="xl166" style='border:.5pt solid windowtext;'>${elevatorPraram.edinggonglv }</td>
    <td class="xl166" style='border:.5pt solid windowtext;' x:str>kW</td>
    <td class="xl166" colspan="2" style='border:.5pt solid windowtext;' x:str>额定转速</td>
    <td class="xl166" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.edingzhuansu }</td>
    <td class="xl166" style='border:.5pt solid windowtext;' x:str>r/min</td>
   </tr>
   <tr height="28" style='height:21.00pt;mso-height-source:userset;mso-height-alt:420;'>
    <td class="xl173" colspan="5" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>减速比(适用于有齿减速)</td>
    <td class="xl173" colspan="5" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.jiansubi }</td>
   </tr>
   <tr height="40" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl166" height="40" style='height:30.00pt;'  style='border:.5pt solid windowtext;' x:str>液压泵站</td>
    <td class="xl173" colspan="5" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>满载工作压力 (适用于液压驱动电梯)</td>
    <td class="xl173" colspan="4" style='border-right:none;border-bottom:.5pt solid windowtext;'>${elevatorPraram.gongzuoyali }</td>
    <td class="xl175" style='border:.5pt solid windowtext;' x:str>MPa</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl176" height="61.33" rowspan="2" style='height:46.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>悬挂系统</td>
    <td class="xl166" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>悬挂介质种类</td>
    <td class="xl166" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.jiezhizhonglei }</td>
    <td class="xl166" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>悬挂介质数量</td>
    <td class="xl166" style='border:.5pt solid windowtext;'>${elevatorPraram.jiezhishuliang }</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl166" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>悬挂介质型号</td>
    <td class="xl166" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${elevatorPraram.jiezhixinghao }</td>
    <td class="xl166" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>悬挂介质规格</td>
    <td class="xl166" style='border:.5pt solid windowtext;'>${elevatorPraram.jiezhiguige }</td>
   </tr>
