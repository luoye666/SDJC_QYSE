 ...
 <body link="blue" vlink="purple" class="xl65">
  <table width="713.40" border="0" cellpadding="0" cellspacing="0" style='width:535.05pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="44" class="xl65" style='height:33.00pt;mso-height-source:userset;mso-height-alt:660;'>
    ...
    <td class="xl68" colspan="2" style='border-right:none;border-bottom:.5pt solid windowtext;'></td>
    <td class="xl68" colspan="2" style='border-right:none;border-bottom:.5pt solid windowtext;'></td>
    <td class="xl93" colspan="2" style='border-right:none;border-bottom:.5pt solid windowtext;' x:str>${baseInfo.dengjizhengbianhao }</td>
   ...
   <tr height="40" class="xl65" style='height:30.00pt;mso-height-source:userset;mso-height-alt:600;'>
    <td class="xl94" height="40" colspan="11" style='height:30.00pt;border-right:none;border-bottom:none;' x:str>客运索道产品数据表</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl156" height="30.67" colspan="5" style='height:23.00pt;mso-ignore:colspan;'></td>
    <td class="xl158" colspan="2" style='border-right:none;border-bottom:none;' x:str>编号：</td>
    <td class="xl159" colspan="4" style='border-right:none;border-bottom:none;'></td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl160" height="30.67" colspan="2" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>设备品种(名称)</td>
    <td class="xl161" colspan="4" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${cable.shebeipinzhong}</td>
    <td class="xl160" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>产品总图图号</td>
    <td class="xl161" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${cable.chanpintuhao}</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl164" height="30.67" colspan="11" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:none;text-align: center;' x:str>主要参数</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl160" height="30.67" colspan="2" style='height:23.00pt;border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>平<span style='mso-spacerun:yes;'>&nbsp; </span>距</td>
    <td class="xl161" colspan="3" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${cable.pingju}</td>
    <td class="xl167" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl163" colspan="2" style='border:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>支架数目</td>
    <td class="xl168" colspan="2" style='border:.5pt solid windowtext;'>${cable.zhijiashumu}</td>
    <td class="xl174" style='border:.5pt solid windowtext;' x:str>个</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:660;'>
    <td class="xl160" height="30.67" colspan="2" style='height:23.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>斜<span style='mso-spacerun:yes;'>&nbsp; </span>长</td>
    <td class="xl161" colspan="3" style='border-right:none;border-bottom:.5pt solid windowtext;'>${cable.xiechang}</td>
    <td class="xl169" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl74" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>主电机型号和功率</td>
    <td class="xl170" colspan="2" style='border:.5pt solid windowtext;'>${cable.dianjiexinghaogonglv}</td>
    <td class="xl174" style='border:.5pt solid windowtext;' x:str>kW</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:660;'>
    <td class="xl160" height="30.67" colspan="2" style='height:23.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>高<span style='mso-spacerun:yes;'>&nbsp; </span>差</td>
    <td class="xl161" colspan="3" style='border-right:none;border-bottom:.5pt solid windowtext;'>${cable.gaocha}</td>
    <td class="xl167" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl74" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str><font class="font14">张紧油压</font><font class="font14">(</font><font class="font14">重锤重量</font><font class="font14">)</font></td>
    <td class="xl161" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${cable.zhangjinyouya}</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:660;'>
    <td class="xl160" height="30.67" colspan="2" style='height:23.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>运<span style='mso-spacerun:yes;'>&nbsp; </span>量</td>
    <td class="xl161" colspan="3" style='border-right:none;border-bottom:.5pt solid windowtext;'>${cable.yunliang}</td>
    <td class="xl169" style='border:.5pt solid windowtext;' x:str>人/小时</td>
    <td class="xl74" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str><font class="font14">运载索</font><font class="font14">(</font><font class="font14">牵引索、平衡索</font><font class="font14">)</font></td>
    <td class="xl161" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${cable.yunzaigongju}</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:460;'>
    <td class="xl160" height="30.67" colspan="2" style='height:23.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>速<span style='mso-spacerun:yes;'>&nbsp; </span>度</td>
    <td class="xl161" colspan="3" style='border-right:none;border-bottom:.5pt solid windowtext;'>${cable.yunxingsudu}</td>
    <td class="xl167" style='border:.5pt solid windowtext;' x:str>m/s</td>
    <td class="xl163" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>承载索</td>
    <td class="xl161" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${cable.chengzaisuo}</td>
   </tr>
   <tr height="30.67" style='height:23.00pt;mso-height-source:userset;mso-height-alt:660;'>
    <td class="xl160" height="30.67" colspan="2" style='height:23.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>索<span style='mso-spacerun:yes;'>&nbsp; </span>距</td>
    <td class="xl161" colspan="3" style='border-right:none;border-bottom:.5pt solid windowtext;'>${cable.suoju}</td>
    <td class="xl167" style='border:.5pt solid windowtext;' x:str>m</td>
    <td class="xl74" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>运载工具数量和类型</td>
    <td class="xl161" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${cable.yunzaigongju}</td>
   </tr>
  </table>
 </body>
