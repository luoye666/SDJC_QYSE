...
<div id="container" class="container" >
					...
					<table style="width: 100%">
						<tr>
							<td style="width: 72%;height: 1cm"></td>
							<td style="font-size: 24px;font-family: 黑体;text-align: left;">
					...
					<table class="neirong">
						...
						<tr>
							...
							<td style="width: 28%;padding-top: 3mm">
								${reg.shebeizhonglei}
							</td>
							<td style="width: 12%"></td>
							<td style="width: 34%;padding-top: 3mm">
								&nbsp;&nbsp;${reg.shebeileibie}
							</td>
						</tr>
						<tr>
					...
					<table style="width: 100%">
						<tr>
							<td style="width: 66%;height: 1cm"></td>
