...
<!--startprint-->
					...
					<div>
						...
						<table class="tabjcxx">
							...
							<tr>
								<td>压力容器品种</td>
								<td>${register.ylrq_pinzhong}</td>
								<td colspan="2">主体结构型式</td>
								<td>${register.jiegouxingshi}</td>
							</tr>
							<tr>
								<td>设备使用年限</td>
							...
							<tr>
								...
								<td style="width: 20%">${register.shiyongchanghe}</td>
								<td rowspan="3" style="width: 15%">设备地理信息</td>
								<td style="width: 15%">经度</td>
								<td style="width: 20%">${register.jingdu}</td>
							</tr>
							<tr>
								<td>运行状态</td>
								<td>
							...
							<tr>
								<td>设计单位名称</td>
								<td colspan="4">${register.shejidanwei}</td>
							</tr>
							<tr>
								<td>设计许可证编号</td>
								<td>${register.shejixukezhengbianhao}</td>
								<td colspan="2">产品图号</td>
								<td>${register.chanpintuhao}</td>
							</tr>
							<tr>
								<td>型式试验机构</td>
								<td colspan="4">${register.xingshishiyanjiegou}</td>
							</tr>
							<tr>
								<td>试验机构核准证编号</td>
								<td>${register.shiyanjiegouhezhunzheng}</td>
								<td colspan="2">型式试验证书编号</td>
								<td>${register.xingshishiyanzhengshu}</td>
							</tr>
							<tr>
								<td>制造监检机构</td>
							...
							<tr>
								...
								<td>施工单位名称</td>
								<td colspan="4">${register.shigongdanwei}</td>
							</tr>
							<tr>
								<td>施工许可证编号</td>
							...
							<tr>
								...
								<td colspan="2">充装量/额定人数</td>
								<td>${register.chongzhuangliang}</td>
							</tr>
							<tr>
								...
								<td colspan="6">
									...
									<table class="shuoming">
										<tr>
											...
											<td style="width: 15%">${register.tianbiaorenyuan }</td>
										...
										<tr>
											<td colspan="5">
												首次定期检验日期：
												<fmt:formatDate value="${register.dingqijianyanriqi}" pattern="yyyy-MM-dd"/>
											</td>
										</tr>
									</table>
								</td>
								...
								<td colspan="6">
									...
									<table class="shuoming">
										<tr>
											...
											<td style="width: 15%">${register.zhucedengjirenyuan }</td>
											<td style="width: 20%">日期：</td>
											<td style="width: 20%">
										...
										<tr>
											<td>安全状况等级：${register.anquanzhuangkuangdengji }级</td>
											<td>监管类别：</td>
											<td>${register.jianguanleibie }</td>
											<td>使用登记证编号：</td>
											<td>${register.shiyongdengjizhenghaoma }</td>
										</tr>
									</table>
								</td>
							</tr>
