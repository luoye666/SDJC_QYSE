...
@XmlRootElement(name = "TBaseInfo")
@JsonIgnoreProperties(ignoreUnknown = true)
public class TBaseInfo implements java.io.Serializable {
	...
	/**
	 * 是否注册 0 未注册    1 已注册---定期检监  2  已告知----安装监检  3 已停用  4 改造维修监检 5拆除 注销6待办 7报废
	 * use_stateid  001：在用，002：停用，003：报废，004：拆除，005：注销，006：移装 注销
	 * state 1 已批   3 待办 
	 */
	...
	private String jingbanren; //经办人(使用单位使用经办人)
	private String jingbanrendianhua; // 经办人电话(使用单位使用经办人)
	/**************************************制造单位 ***************************************************************/
	/**
	 * 制造单位 
	 */
	...
	private String chanpintuhao; //产品图号
	/*************** ************************施工单位**************************************************************/
	/**
	 * 施工单位（安装单位）
	 */
	...
	private String shejixukezheng; //设计许可证
	/*********************************************登记证***************************************************************/
	/**
	 * 使用登记证编号
	 */
...
//	private String zhizaoriqi2;//制造日期月
	...
	private String chongfu = "0";//重复数据 2016-11-1 0 正常  1 重复  2 不合格
	...
	/**
	 * 2017-11-04 
	 * 原因：特检院向监察系统中写入报检日期、约检日期、约定检验日期、报检开始日期、报检结束日期
	 */
	/**
	 * 报检日期  （已存在的日期不是新增的）
	 */
	...
	private Date yuejianirqi; //约检日期
	
	private Date yuedingjianyanriqi; //约定检验日期
	
	private Date baojiankaishiriqi; //报检开始日期
	
	private Date baojianjieshuriqi;//报检结束日期
	
	private String yjyy = "0"; //超期原因
	...
	public String getShejixukezheng() {
		return shejixukezheng;
	}

	public void setShejixukezheng(String shejixukezheng) {
		this.shejixukezheng = shejixukezheng;
	}
	...
	public Date getYuejianirqi() {
		return yuejianirqi;
	}

	public void setYuejianirqi(Date yuejianirqi) {
		this.yuejianirqi = yuejianirqi;
	}

	public Date getYuedingjianyanriqi() {
		return yuedingjianyanriqi;
	}

	public void setYuedingjianyanriqi(Date yuedingjianyanriqi) {
		this.yuedingjianyanriqi = yuedingjianyanriqi;
	}

	public Date getBaojiankaishiriqi() {
		return baojiankaishiriqi;
	}

	public void setBaojiankaishiriqi(Date baojiankaishiriqi) {
		this.baojiankaishiriqi = baojiankaishiriqi;
	}

	public Date getBaojianjieshuriqi() {
		return baojianjieshuriqi;
	}

	public void setBaojianjieshuriqi(Date baojianjieshuriqi) {
		this.baojianjieshuriqi = baojianjieshuriqi;
	}
