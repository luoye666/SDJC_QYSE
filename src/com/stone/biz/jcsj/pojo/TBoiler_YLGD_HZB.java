 ...
 */
@Entity
@Table(name="BIZ_BOILER_YLGD_HZB")
public class TBoiler_YLGD_HZB {

	@Id
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEQ_BIZ_BOILER_YLGD_HZB")
    @SequenceGenerator(name="SEQ_BIZ_BOILER_YLGD_HZB",allocationSize=1, sequenceName="SEQ_BIZ_BOILER_YLGD_HZB")
	...
	public void setSe_id(Long seId) {
		se_id = seId;
	}
